...
export default defineConfig({
  ...
  webServer: {
    ...
    env: {
      ...
      ENABLED_FEATURES: "doc-upload,email-alerts,hcaptcha,view-personal-info,view-applications,view-letters,view-messages,edit-personal-info,status,show-prototype-banner,dependent-status-check",
