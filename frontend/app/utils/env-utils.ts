...
const validFeatureNames = ['doc-upload', 'hcaptcha', 'view-letters', 'view-messages', 'status', 'show-prototype-banner', 'view-payload', 'status-checker-redirects', 'stub-login'] as const;
