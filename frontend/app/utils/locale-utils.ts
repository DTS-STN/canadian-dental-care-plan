 ...
 */
export function getNameByLanguage(language: string, languageTranslation: { nameEn?: string; nameFr?: string }) {
  return language == 'fr' ? languageTranslation.nameFr : languageTranslation.nameEn;
}
