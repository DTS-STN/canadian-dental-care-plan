...
const serverEnv = z.object({
  ...
  CLIENT_STATUS_ID: z.string().trim().min(1),
  ...
  LOOKUP_SVC_ALL_FEDERAL_DENTAL_BENEFITS_CACHE_TTL_SECONDS: z.coerce.number().default(24 * 60 * 60),
  ...
  LOOKUP_SVC_ALL_PROVINCIAL_TERRITORIAL_DENTAL_BENEFITS_CACHE_TTL_SECONDS: z.coerce.number().default(24 * 60 * 60),
