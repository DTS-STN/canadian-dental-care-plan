export const SERVICE_IDENTIFIER = {
  ...
  APPLICANT_DTO_MAPPER: Symbol.for('ApplicantDtoMapper'),
  APPLICANT_REPOSITORY: Symbol.for('ApplicantRepository'),
  APPLICANT_SERVICE: Symbol.for('ApplicantService'),
  ...
  DEMOGRAPHIC_SURVEY_DTO_MAPPER: Symbol.for('DemographicSurveyDtoMapper'),
  DEMOGRAPHIC_SURVEY_REPOSITORY: Symbol.for('DemographicSurveyRepository'),
  DEMOGRAPHIC_SURVEY_SERVICE: Symbol.for('DemographicSurveyService'),
  ...
  CONTAINER_WEB_VALIDATOR_PROVIDER: Symbol.for('ContainerWebValidatorProvider'),
  ...
  LETTER_DTO_MAPPER: Symbol.for('LetterDtoMapper'),
  LETTER_REPOSITORY: Symbol.for('LetterRepository'),
  LETTER_SERVICE: Symbol.for('LetterService'),
