...
import type {
  ...
  FederalProvincialGovernmentInsurancePlanRepository,
  LetterRepository,
...
export const TYPES = assignServiceIdentifiers({
  ...
  domain: {
    ...
    repositories: {
      ...
      FederalProvincialGovernmentInsurancePlanRepository: serviceId<FederalProvincialGovernmentInsurancePlanRepository>(),
