...
import { DefaultMailingAddressValidatorFactoryAdult } from '~/.server/routes/public/renew/adult';
...
export const factoriesContainerModule = new ContainerModule((bind) => {
  ...
  bind(TYPES.routes.public.renew.adult.MailingAddressValidatorFactoryAdult).to(DefaultMailingAddressValidatorFactoryAdult);
