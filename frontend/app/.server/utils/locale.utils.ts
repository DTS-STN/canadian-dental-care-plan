...
export const i18nResources = {
  en: {
    addressValidation: addressValidationEn,
    applyAdultChild: applyAdultChildEn,
    applyAdult: applyAdultEn,
    applyChild: applyChildEn,
    apply: applyEn,
    dataUnavailable: dataUnavailableEn,
    gcweb: gcwebEn,
    index: indexEn,
    letters: lettersEn,
    protectedRenew: protectedRenewEn,
    renewAdultChild: renewAdultChildEn,
    renewChild: renewChildEn,
    renewIta: renewItaEn,
    renew: renewEn,
    status: statusEn,
  ...
  fr: {
    addressValidation: addressValidationFr,
    applyAdultChild: applyAdultChildFr,
    applyAdult: applyAdultFr,
    applyChild: applyChildFr,
    apply: applyFr,
    dataUnavailable: dataUnavailableFr,
    gcweb: gcwebFr,
    index: indexFr,
    letters: lettersFr,
    protectedRenew: protectedRenewFr,
    renewAdultChild: renewAdultChildFr,
    renewChild: renewChildFr,
    renewIta: renewItaFr,
    renew: renewFr,
    status: statusFr,
