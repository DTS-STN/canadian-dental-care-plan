...
import type { BenefitRenewalDto } from '../dtos/benefit-renewal.dto';
import type { BenefitRenewalRequestEntity } from '../entities';
import type {
...
export interface BenefitRenewalDtoMapper {
  mapClientRenewalRequestToClientRenewalDto(benefitRenewalRequest: ToBenefitRenewalRequestArgs): BenefitRenewalDto;
}

@injectable()
export class BenefitRenewalDtoMapperImpl implements BenefitRenewalDtoMapper {
  mapClientRenewalRequestToClientRenewalDto(benefitRenewalRequest: ToBenefitRenewalRequestArgs): BenefitRenewalDto {
    return toBenefitRenewalRequest(benefitRenewalRequest);
  }
}
