...
export interface BenefitRenewalRepository {
   ...
   */
  submitRenewal(benefitRenewalRequest: BenefitRenewalRequestEntity): Promise<BenefitRenewalResponseEntity | null>;
}
...
export class BenefitRenewalRepositoryImpl implements BenefitRenewalRepository {
  ...
  async submitRenewal(benefitRenewalRequest: BenefitRenewalRequestEntity): Promise<BenefitRenewalResponseEntity | null> {
