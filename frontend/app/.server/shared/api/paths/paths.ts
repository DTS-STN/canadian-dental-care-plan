...
import type { RetrieveBenefitApplicationConfigDates } from '~/.server/shared/api/paths/retrieve-benefit-application-config-dates.path';
...
export type Paths = {
  ...
  '/retrieve-benefit-application': RetrieveBenefitApplicationConfigDates;
  '/retrieve-benefit-application-config-dates': RetrieveBenefitApplicationPath;
};
