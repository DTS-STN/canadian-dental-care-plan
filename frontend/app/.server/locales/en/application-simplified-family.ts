const ns = {
  ...
  dentalInsurance: {
    ...
    dentalBenefitsIndicateStatus: "Would you like to update your access to other government dental benefits?",
  ...
  childrensApplication: {
    ...
    addAnswer: "Add answer",
    childInformationIndicateStatus: "Enter your child's name, date of birth and Member ID.",
