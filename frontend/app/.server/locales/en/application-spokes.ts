const ns = {
  ...
  communicationPreferences: {
    ...
    preferredNotificationMethod: "How would you like to receive updates from the Government of Canada about the Canadian Dental Care Plan?",
    preferredNotificationMethodMsca: "<span>{{name}}</span><br><mscaLinkAccount>Signing up</mscaLinkAccount> for online notifications is the fastest way to get updates.",
    preferredNotificationMethodMail: "<span>{{name}}</span><br>You can also view your Canadian Dental Care Plan information in your <mscaLinkAccount>MSCA</mscaLinkAccount>.",
    back: "Back",
    continue: "Continue",
    save: "Save",
  ...
  children: {
    ...
    information: {
      ...
      nameInstructions: "If the child uses one legal name, please enter that name in BOTH the first name and last name fields.",
      lastName: "Last name",
      firstName: "First name",
      ...
      errorMessage: {
        memberIdRequired: "Enter 11-digit member ID",
        memberIdValid: "Member ID must be 11-digit",
        memberIdUnique: "Member ID must be unique across all children in this application",
    ...
    parentOrGuardian: {
      ...
      mustBe: "You must be a parent or legal guardian.",
    ...
    cannotApplyChild: {
      ...
      ineligibleToApply: {
        adultApplication: "Your child is 18 years or older. Your child must submit their own application to the Canadian Dental Care Plan.",
        cutoffApplication: "Your child will turn 18 by July 1, 2026. Once they turn 18, they must submit their own application.",
      },
