const ns = {
  ...
  confirm: {
    ...
    gocCommPrefTitle: "Government of Canada communication preference",
    email: "Email address",
  ...
  submit: {
    ...
    childrenApplication: "Your child(ren)'s application",
    submit: "Submit",
  ...
  childrensApplication: {
    ...
    addChildDentalInsurance: "Add answer",
    addChildDentalBenefits: "Add answer",
    ...
    dentalBenefitsYes: "Yes, this child has federal, provincial or territorial dental benefits",
    dentalBenefitsNo: "No, this child does not have federal, provincial or territorial dental benefits",
