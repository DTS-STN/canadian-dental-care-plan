const ns = {
  ...
  "terms-conditions": "By using the Status Checker you agree to the following Terms and Conditions of Use and Privacy Notice Statement.",
  ...
  "privacy-notice-statement": {
    ...
    "collection-of-use": "The collection and use of your personal information is authorized under the <cite>Department of Health Act</cite>, the <cite>Dental Care Measures Act</cite>, the <cite>Department of Employment and Social Development Act</cite>, and other applicable laws.",
  ...
  "form": {
    ...
    "radio-legend": "Are you checking the status for yourself or for your child?",
    "radio-text": {
    ...
    "submit": "Check status",
    "error-message": {
      "selection-required": "Select whether you are checking the status for yourself or your child",
    },
  },
  "myself": {
    "page-title": "Status Checker",
    ...
    "form": {
      "complete-fields": "Complete all fields.",
      "application-code-label": "Application Code or Client Number",
      "application-code-description": "Enter the number you received after applying online, or the number found in the upper right-hand corner from the letter you may have received from Service Canada",
      "sin-label": "Social Insurance Number (SIN)",
      ...
      "error-message": {
        ...
        "sin-valid": "The SIN entered does not exist",
        "application-code-required": "Enter Application Code or Client Number",
        "application-code-valid": "Must be a valid Application Code or Client Number. Your input must be 6, 11 or 13 digits long.",
      },
    },
  },
  "child": {
    ...
    "form": {
      "complete-fields": "Complete all fields.",
      "application-code-label": "Application Code or Client Number",
      "application-code-description": "The number you received after applying, or your child’s Client Number in the right-hand corner of the CDCP letter they received from Service Canada",
      "radio-legend": "Does the child have a Social Insurance Number (SIN)?",
      "sin-label": "Social Insurance Number (SIN)",
      "sin-description": "Enter the 9-digit SIN",
      "option-yes": "<strong>Yes</strong>, the child has a SIN",
      "option-no": "<strong>No</strong>, the child does not have a SIN",
      ...
      "back-btn": "Back",
      "error-message": {
        "radio-required": "Select whether the child has a SIN",
        "sin-required": "Enter 9-digit SIN, for example 123 456 789",
        "sin-valid": "The SIN entered does not exist",
        "application-code-required": "Enter Application Code or Client Number",
        "application-code-valid": "Must be a valid Application Code or Client Number. Your input must be 6, 11 or 13 digits long.",
        "first-name-too-long": "First name too long",
  ...
  "result": {
    ...
    "exit-btn": "Exit status checker",
    "exit-link": "https://www.canada.ca/en/services/benefits/dental/dental-care-plan/apply.html#status",
    "status-not-found": {
      "heading": "We could not find your application status with the information you gave us.",
      "please-review": "Please make sure the information you entered is correct. If you applied recently, try again in 48 hours.",
      "if-submitted": "If you have submitted more than one application for yourself, your children, or both, use the last application code you received.",
