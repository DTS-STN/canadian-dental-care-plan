const ns = {
  ...
  header: {
    ...
    "govtOfCanada.text": "Government of Canada",
    govtOfCanadaHref: "https://www.canada.ca/en.html",
    menuTitle: "Account",
    "menuInbox.text": "Inbox",
    menuInboxHref: "{{baseUri}}/en/inbox",
    "menuDashboard.text": "My dashboard",
    ...
    "menuSecuritySettings.text": "Security Settings",
    menuSecuritySettingsHref: "{{baseUri}}/en/security-settings",
    "menuContactUs.text": "Contact Us",
    menuContactUsHref: "{{baseUri}}/en/contact-us",
    "menuSignOut.text": "Sign Out",
    banner: {
      alert: "Alpha",
