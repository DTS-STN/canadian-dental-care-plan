const ns = {
  ...
  confirm: {
    ...
    getUpdatesText: "<mscaLinkAccount>Mon dossier Service Canada (MDSC)</mscaLinkAccount> est le moyen le plus rapide de recevoir des renseignements importants sur le Régime canadien de soins dentaires.",
    getUpdatesInfo: "Une fois votre demande traitée, vous pouvez vous connecter à MDSC pour\u00A0:",
  ...
  submit: {
    ...
    childrenApplication: "La demande de votre/vos enfant(s)",
    submit: "Soumettre",
  ...
  childrensApplication: {
    ...
    addChildDentalInsurance: "Ajouter une réponse",
    addChildDentalBenefits: "Ajouter une réponse",
    childInformationIndicate: {
    ...
    yes: "Oui",
    no: "Non",
    dentalInsuranceYes: "Oui, cet enfant a accès à une assurance ou à une couverture dentaire privée",
    dentalInsuranceNo: "Non, cet enfant n'a pas accès à une assurance ou à une couverture dentaire privée",
    dentalBenefitsYes: "Oui, cet enfant reçoit des prestations dentaires fédérales, provinciales ou territoriales",
    dentalBenefitsNo: "Non, cet enfant ne reçoit pas des prestations dentaires fédérales, provinciales ou territoriales",
