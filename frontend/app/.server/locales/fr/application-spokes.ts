const ns = {
  ...
  communicationPreferences: {
    ...
    preferredNotificationMethod: "Comment souhaitez-vous recevoir les mises à jour du gouvernement du Canada concernant le Régime canadien de soins dentaires?",
    preferredNotificationMethodMsca: "<span>{{name}}</span><br><mscaLinkAccount>S'inscrire aux notifications</mscaLinkAccount> en ligne est le moyen le plus rapide d'obtenir des mises à jour.",
    preferredNotificationMethodMail: "<span>{{name}}</span><br>Vous pouvez également consulter les renseignements figurant à votre dossier du Régime canadien de soins dentaires dans <mscaLinkAccount>MDSC</mscaLinkAccount>.",
    back: "Retour",
    continue: "Continuer",
    save: "Sauvegarder",
  ...
  email: {
    ...
    provideEmail: "Indiquez l'adresse électronique à laquelle vous souhaitez recevoir l'information au sujet de votre couverture au titre du Régime canadien de soins dentaires que vous communiqueront le gouvernement du Canada et la Sun Life.",
    verifyEmail: "Nous devrons confirmer votre adresse électronique.",
  ...
  children: {
    ...
    information: {
      ...
      errorMessage: {
        memberIdRequired: "Entrez le numéro d'identification du membre à 11 chiffres",
        memberIdValid: "Le numéro d'identification du membre doit comporter 11 chiffres",
        memberIdUnique: "Le numéro d'identification du membre doit être unique pour tous les enfants de cette demande",
    ...
    parentOrGuardian: {
      ...
      mustBe: "Vous devez être le parent ou le tuteur légal",
    ...
    cannotApplyChild: {
      ...
      ineligibleToApply: {
        adultApplication: "Votre enfant a 18 ans ou plus. Votre enfant doit présenter sa propre demande au titre du Régime canadien de soins dentaires.",
        cutoffApplication: "Votre enfant aura 18 ans au plus tard le 1er juillet 2026. Une fois cet âge atteint, il ou elle devra présenter sa propre demande.",
      },
