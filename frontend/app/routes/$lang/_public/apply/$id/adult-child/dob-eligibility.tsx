...
export default function ApplyFlowDobEligibility() {
  ...
  const eligibilityInfo = <InlineLink to={t('apply-adult-child:eligibility.dob-eligibility.eligibility-info-href')} className="external-link font-lato font-semibold" newTabIndicator target="_blank" />;
  ...
  return (
    <div className="max-w-prose">
      ...
      <fetcher.Form method="post" onSubmit={handleSubmit} noValidate className="flex flex-wrap items-center gap-3">
        ...
        <ButtonLink type="button" routeId="$lang/_public/apply/$id/adult-child/disability-tax-credit" params={params} disabled={isSubmitting} data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form:Back - Find out when you can apply click">
