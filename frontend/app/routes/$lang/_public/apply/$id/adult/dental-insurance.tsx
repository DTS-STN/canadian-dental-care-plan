...
export async function action({ context: { session }, params, request }: ActionFunctionArgs) {
  ...
  const dentalInsuranceSchema = z.boolean({ errorMap: () => ({ message: t('apply-adult:dental-insurance.error-message.dental-insurance-required') }) });
  ...
  return (
    <>
      <div className="my-6 sm:my-8">
        <Progress value={77} size="lg" label={t('apply:progress.label')} />
      </div>
        ...
        <fetcher.Form method="post" noValidate>
          ...
          {editMode ? (
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <Button variant="primary" data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form-Adult:Save - Access to other dental insurance click">
              ...
              <ButtonLink
                ...
                data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form-Adult:Cancel - Access to other dental insurance click"
              >
            ...
            <div className="mt-8 flex flex-row-reverse flex-wrap items-center justify-end gap-3">
              <Button variant="primary" data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form-Adult:Continue - Access to other dental insurance click">
