...
export async function loader({ context: { session }, params, request }: LoaderFunctionArgs) {
  ...
  const meta = { title: t('gcweb:meta.title.template', { title: t('apply-child:children.dental-insurance.title', { childName }) }) };
...
export async function action({ context: { session }, params, request }: ActionFunctionArgs) {
  ...
  const dentalInsuranceSchema = z.boolean({ errorMap: () => ({ message: t('apply-child:children.dental-insurance.error-message.dental-insurance-required') }) });
  ...
  return redirect(getPathById('$lang/_public/apply/$id/child/children/$childId/federal-provincial-territorial-benefits', params));
}
        ...
        <fetcher.Form method="post" noValidate>
          ...
          {editMode ? (
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <Button variant="primary" data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form-Child:Save - Access to other dental insurance click">
              ...
              <ButtonLink
                ...
                data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form-Child:Cancel - Access to other dental insurance click"
              >
            ...
            <div className="mt-8 flex flex-row-reverse flex-wrap items-center justify-end gap-3">
              <Button variant="primary" data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form-Child:Continue - Access to other dental insurance click">
              ...
              <ButtonLink
                ...
                params={params}
                disabled={isSubmitting}
                data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form-Child:Back - Access to other dental insurance click"
              >
