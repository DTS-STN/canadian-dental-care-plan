...
export async function action({ context: { session }, params, request }: ActionFunctionArgs) {
  ...
  // TODO: Change getStatusId call for the new API call. (Coming soon) **Update: Email has been received. Working on it.
  // TODO: Create 2 functions - getChildStatusIdBySin & getChildStatusIdByPersonalInfo
  const statusId = await applicationStatusService.getStatusId({
