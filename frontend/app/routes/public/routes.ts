        ...
        children: [
          {
            ...
            paths: { en: '/:lang/renew', fr: '/:lang/renouveler' },
          },
          {
            id: 'public/renew/$id/terms-and-conditions',
            file: 'routes/public/renew/$id/terms-and-conditions.tsx',
            paths: { en: '/:lang/renew/:id/terms-and-conditions', fr: '/:lang/renouveler/:id/conditions-utilisation' },
          },
          {
            id: 'public/renew/$id/applicant-information',
            file: 'routes/public/renew/$id/applicant-information.tsx',
            paths: { en: '/:lang/renew/:id/applicant-information', fr: '/:lang/renouveler/:id/renseignements-demandeur' },
          },
          {
            id: 'public/renew/$id/type-renewal',
            file: 'routes/public/renew/$id/type-renewal.tsx',
            paths: { en: '/:lang/renew/:id/type-renewal', fr: '/:lang/renouveler/:id/type-renouvellement' },
          },
          {
            id: 'public/renew/$id/renewal-delegate',
            file: 'routes/public/renew/$id/renewal-delegate.tsx',
            paths: { en: '/:lang/renew/:id/renewal-delegate', fr: '/:lang/renouveler/:id/renouvellement-delegue' },
          },
          {
            id: 'public/renew/$id/tax-filing',
            file: 'routes/public/renew/$id/tax-filing.tsx',
            paths: { en: '/:lang/renew/:id/tax-filing', fr: '/:lang/renouveler/:id/declaration-impot' },
          },
          {
            id: 'public/renew/$id/file-taxes',
            file: 'routes/public/renew/$id/file-taxes.tsx',
            paths: { en: '/:lang/renew/:id/file-taxes', fr: '/:lang/renouveler/:id/produire-declaration-revenus' },
          },
          {
            id: 'public/renew/$id/ita/marital-status',
            file: 'routes/public/renew/$id/ita/marital-status.tsx',
            paths: { en: '/:lang/renew/:id/ita/marital-status', fr: '/:lang/renouveler/:id/ita/etat-civil' },
          },
          {
            id: 'public/renew/$id/ita/confirm-phone',
            file: 'routes/public/renew/$id/ita/confirm-phone.tsx',
            paths: { en: '/:lang/renew/:id/ita/confirm-phone', fr: '/:lang/renouveler/:id/ita/confirmer-telephone' },
          },
          {
            id: 'public/renew/$id/ita/confirm-email',
            file: 'routes/public/renew/$id/ita/confirm-email.tsx',
            paths: { en: '/:lang/renew/:id/ita/confirm-email', fr: '/:lang/renouveler/:id/ita/confirmer-courriel' },
          },
          {
            id: 'public/renew/$id/ita/confirm-address',
            file: 'routes/public/renew/$id/ita/confirm-address.tsx',
            paths: { en: '/:lang/renew/:id/ita/confirm-address', fr: '/:lang/renouveler/:id/ita/confirmer-adresse' },
          },
          {
            id: 'public/renew/$id/ita/update-mailing-address',
            file: 'routes/public/renew/$id/ita/update-mailing-address.tsx',
            paths: { en: '/:lang/renew/:id/ita/update-mailing-address', fr: '/:lang/renouveler/:id/ita/mise-a-jour-adresse-postale' },
          },
          {
            id: 'public/renew/$id/ita/update-home-address',
            file: 'routes/public/renew/$id/ita/update-home-address.tsx',
            paths: { en: '/:lang/renew/:id/ita/update-home-address', fr: '/:lang/renouveler/:id/ita/mise-a-jour-adresse-domicile' },
          },
          {
            id: 'public/renew/$id/ita/dental-insurance',
            file: 'routes/public/renew/$id/ita/dental-insurance.tsx',
            paths: { en: '/:lang/renew/:id/ita/dental-insurance', fr: '/:lang/renouveler/:id/ita/assurance-dentaire' },
          },
          {
          ...
          },
          {
            ...
            paths: { en: '/:lang/renew/:id/ita/review-information', fr: '/:lang/renouveler/:id/ita/revue-renseignements' },
          },
          {
            id: 'public/renew/$id/ita/confirmation',
            file: 'routes/public/renew/$id/ita/confirmation.tsx',
            paths: { en: '/:lang/renew/:id/ita/confirmation', fr: '/:lang/renouveler/:id/ita/confirmation' },
          },
          {
            id: 'public/renew/$id/ita/exit-application',
            file: 'routes/public/renew/$id/ita/exit-application.tsx',
            paths: { en: '/:lang/renew/:id/ita/exit-application', fr: '/:lang/renouveler/:id/ita/quitter-demande' },
          },
          {
            id: 'public/renew/$id/ita/demographic-survey',
            file: 'routes/public/renew/$id/ita/demographic-survey.tsx',
            paths: { en: '/:lang/renew/:id/ita/demographic-survey', fr: '/:lang/renouveler/:id/ita/questionnaire-demographique' },
          },
          {
          ...
          },
          {
            ...
            paths: { en: '/:lang/renew/:id/adult-child/marital-status', fr: '/:lang/renouveler/:id/adulte-enfant/etat-civil' },
          },
          {
            id: 'public/renew/$id/adult-child/confirmation',
            file: 'routes/public/renew/$id/adult-child/confirmation.tsx',
            paths: { en: '/:lang/renew/:id/adult-child/confirmation', fr: '/:lang/renouveler/:id/adulte-enfant/confirmation' },
          },
          {
            id: 'public/renew/$id/adult-child/confirm-phone',
            file: 'routes/public/renew/$id/adult-child/confirm-phone.tsx',
            paths: { en: '/:lang/renew/:id/adult-child/confirm-phone', fr: '/:lang/renouveler/:id/adulte-enfant/confirmer-telephone' },
          },
          {
            id: 'public/renew/$id/adult-child/confirm-email',
            file: 'routes/public/renew/$id/adult-child/confirm-email.tsx',
            paths: { en: '/:lang/renew/:id/adult-child/confirm-email', fr: '/:lang/renouveler/:id/adulte-enfant/confirmer-courriel' },
          },
          {
            id: 'public/renew/$id/adult-child/confirm-address',
            file: 'routes/public/renew/$id/adult-child/confirm-address.tsx',
            paths: { en: '/:lang/renew/:id/adult-child/confirm-address', fr: '/:lang/renouveler/:id/adulte-enfant/confirmer-adresse' },
          },
          {
          ...
          },
          {
            ...
            paths: { en: '/:lang/renew/:id/adult-child/children', fr: '/:lang/renouveler/:id/adulte-enfant/enfant' },
          },
          {
          ...
          },
          {
            ...
            paths: { en: '/:lang/renew/:id/adult-child/exit-application', fr: '/:lang/renouveler/:id/adulte-enfant/quitter-demande' },
          },
          {
            id: 'public/renew/$id/child/children/index',
            file: 'routes/public/renew/$id/child/children/index.tsx',
            paths: { en: '/:lang/renew/:id/child/children', fr: '/:lang/renouveler/:id/enfant/enfant' },
          },
          {
          ...
          },
          {
            ...
            paths: { en: '/:lang/renew/:id/child/confirmation', fr: '/:lang/renouveler/:id/enfant/confirmation' },
          },
          {
            id: 'public/renew/$id/child/exit-application',
            file: 'routes/public/renew/$id/child/exit-application.tsx',
            paths: { en: '/:lang/renew/:id/child/exit-application', fr: '/:lang/renouveler/:id/enfant/quitter-demande' },
          },

          {
            id: 'public/renew/$id/child/parent-intro',
            file: 'routes/public/renew/$id/child/parent-intro.tsx',
            paths: { en: '/:lang/renew/:id/child/parent-intro', fr: '/:lang/renouveler/:id/enfant/parent-intro' },
          },
          {
            id: 'public/renew/$id/child/confirm-marital-status',
            file: 'routes/public/renew/$id/child/confirm-marital-status.tsx',
            paths: { en: '/:lang/renew/:id/child/confirm-marital-status', fr: '/:lang/renouveler/:id/enfant/confirmer-etat-civil' },
          },
          {
            id: 'public/renew/$id/child/marital-status',
            file: 'routes/public/renew/$id/child/marital-status.tsx',
            paths: { en: '/:lang/renew/:id/child/marital-status', fr: '/:lang/renouveler/:id/enfant/etat-civil' },
          },
          {
            id: 'public/renew/$id/child/confirm-address',
            file: 'routes/public/renew/$id/child/confirm-address.tsx',
            paths: { en: '/:lang/renew/:id/child/confirm-address', fr: '/:lang/renouveler/:id/enfant/confirmer-adresse' },
          },
          {
          ...
          },
          {
            ...
            paths: { en: '/:lang/renew/:id/child/update-home-address', fr: '/:lang/renouveler/:id/enfant/mise-a-jour-adresse-domicile' },
          },

          {
            id: 'public/renew/$id/child/confirm-phone',
            file: 'routes/public/renew/$id/child/confirm-phone.tsx',
            paths: { en: '/:lang/renew/:id/child/confirm-phone', fr: '/:lang/renouveler/:id/enfant/confirmer-telephone' },
          },
          {
            id: 'public/renew/$id/child/confirm-email',
            file: 'routes/public/renew/$id/child/confirm-email.tsx',
            paths: { en: '/:lang/renew/:id/child/confirm-email', fr: '/:lang/renouveler/:id/enfant/confirmer-courriel' },
          },

          {
            id: 'public/renew/$id/adult/confirmation',
            file: 'routes/public/renew/$id/adult/confirmation.tsx',
            paths: { en: '/:lang/renew/:id/adult/confirmation', fr: '/:lang/renouveler/:id/adulte/confirmation' },
          },
          {
            id: 'public/renew/$id/adult/confirm-marital-status',
            file: 'routes/public/renew/$id/adult/confirm-marital-status.tsx',
            paths: { en: '/:lang/renew/:id/adult/confirm-marital-status', fr: '/:lang/renouveler/:id/adulte/confirmer-etat-civil' },
          },
          {
            id: 'public/renew/$id/adult/marital-status',
            file: 'routes/public/renew/$id/adult/marital-status.tsx',
            paths: { en: '/:lang/renew/:id/adult/marital-status', fr: '/:lang/renouveler/:id/adulte/etat-civil' },
          },
          {
            id: 'public/renew/$id/adult/confirm-phone',
            file: 'routes/public/renew/$id/adult/confirm-phone.tsx',
            paths: { en: '/:lang/renew/:id/adult/confirm-phone', fr: '/:lang/renouveler/:id/adulte/confirmer-telephone' },
          },
          {
            id: 'public/renew/$id/adult/confirm-email',
            file: 'routes/public/renew/$id/adult/confirm-email.tsx',
            paths: { en: '/:lang/renew/:id/adult/confirm-email', fr: '/:lang/renouveler/:id/adulte/confirmer-courriel' },
          },
          {
            id: 'public/renew/$id/adult/confirm-address',
            file: 'routes/public/renew/$id/adult/confirm-address.tsx',
            paths: { en: '/:lang/renew/:id/adult/confirm-address', fr: '/:lang/renouveler/:id/adulte/confirmer-adresse' },
          },
          {
          ...
          },
          {
            ...
            paths: { en: '/:lang/renew/:id/adult/update-home-address', fr: '/:lang/renouveler/:id/adulte/mise-a-jour-adresse-domicile' },
          },
          {
            id: 'public/renew/$id/adult/dental-insurance',
            file: 'routes/public/renew/$id/adult/dental-insurance.tsx',
            paths: { en: '/:lang/renew/:id/adult/dental-insurance', fr: '/:lang/renouveler/:id/adulte/assurance-dentaire' },
          },
          {
          ...
          },
          {
            ...
            paths: { en: '/:lang/renew/:id/adult/demographic-survey', fr: '/:lang/renouveler/:id/adulte/questionnaire-demographique' },
          },
          {
          ...
          },
          {
            ...
            paths: { en: '/:lang/renew/:id/adult/exit-application', fr: '/:lang/renouveler/:id/adulte/quitter-demande' },
          },
        ],
      },
      {
