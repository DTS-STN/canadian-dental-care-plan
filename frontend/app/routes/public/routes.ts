    ...
    children: [
      {
        ...
        children: [
          ...
          {
            id: 'public/application/$id/new-adult/contact-information',
            file: 'routes/public/application/new-adult/contact-information.tsx',
            paths: { en: '/:lang/application/:id/new-adult/contact-information', fr: '/:lang/demandes/:id/new-adult/coordonnees' },
          },
          {
            id: 'public/application/$id/new-adult/submit',
            file: 'routes/public/application/new-adult/submit.tsx',
          ...
          {
            id: 'public/application/$id/new-children/confirmation',
            file: 'routes/public/application/new-children/confirmation.tsx',
          ...
          {
            id: 'public/application/$id/renew-adult/confirmation',
            file: 'routes/public/application/renew-adult/confirmation.tsx',
            paths: { en: '/:lang/application/:id/renew-adult/confirmation', fr: '/:lang/demandes/:id/renew-adult/confirmation' },
          },
          {
            id: 'public/application/$id/renew-adult/exit-application',
          ...
          {
            id: 'public/application/$id/renew-children/confirmation',
            file: 'routes/public/application/renew-children/confirmation.tsx',
            paths: { en: '/:lang/application/:id/renew-children/confirmation', fr: '/:lang/demandes/:id/renouveler-enfants/confirmation' },
          },
      ...
      },
      {
        ...
        children: [
          ...
          { id: 'public/apply/$id/adult/phone-number', file: 'routes/public/apply/$id/adult/phone-number.tsx', paths: { en: '/:lang/apply/:id/adult/phone-number', fr: '/:lang/demander/:id/adulte/numero-telephone' } },
          { id: 'public/apply/$id/adult/verify-email', file: 'routes/public/apply/$id/adult/verify-email.tsx', paths: { en: '/:lang/apply/:id/adult/verify-email', fr: '/:lang/demander/:id/adulte/verifier-courriel' } },
          ...
          { id: 'public/apply/$id/child/phone-number', file: 'routes/public/apply/$id/child/phone-number.tsx', paths: { en: '/:lang/apply/:id/child/phone-number', fr: '/:lang/demander/:id/enfant/numero-telephone' } },
          { id: 'public/apply/$id/child/verify-email', file: 'routes/public/apply/$id/child/verify-email.tsx', paths: { en: '/:lang/apply/:id/child/verify-email', fr: '/:lang/demander/:id/enfant/verifier-courriel' } },
