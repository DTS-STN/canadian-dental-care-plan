    ...
    children: [
      {
        ...
        children: [
          ...
          { id: 'public/application/$id/tax-filing', file: 'routes/public/application/tax-filing.tsx', paths: { en: '/:lang/application/:id/tax-filing', fr: '/:lang/demandes/:id/declaration-impot' } },
          { id: 'public/application/$id/file-taxes', file: 'routes/public/application/file-taxes.tsx', paths: { en: '/:lang/application/:id/file-taxes', fr: '/:lang/demandes/:id/produire-declaration-revenus' } },
        ],
      },
      {
