...
export async function action({ context: { appContainer, session }, params, request }: Route.ActionArgs) {
  ...
  const state = loadRenewChildStateForReview({ params, request, session });
  const benefitRenewalDto = appContainer.get(TYPES.BenefitRenewalStateMapper).mapRenewChildStateToChildBenefitRenewalDto(state);
  await appContainer.get(TYPES.BenefitRenewalService).createChildBenefitRenewal(benefitRenewalDto);
    ...
    <>
      ...
      <div className="max-w-prose">
        ...
        <div className="space-y-10">
          <section className="space-y-6">
            ...
            <dl className="divide-y border-y">
              ...
              <DescriptionListItem term={t('renew-child:review-adult-information.marital-title')}>
                <p>{userInfo.maritalStatus ? t(`renew-child:${maritalStatusMap[userInfo.maritalStatus as keyof typeof maritalStatusMap]}`) : ''}</p>
                <div className="mt-4">
                  <InlineLink id="change-marital-status" routeId="public/renew/$id/child/confirm-marital-status" params={params}>
          ...
          <section className="space-y-6">
            <h2 className="font-lato text-2xl font-bold">{t('renew-child:review-adult-information.comm-title')}</h2>
            <dl className="divide-y border-y">
              <DescriptionListItem term={t('renew-child:review-adult-information.sun-life-comm-pref-title')}>
                <p>
                  {userInfo.communicationSunLifePreference === PREFERRED_SUN_LIFE_METHOD.email ? t('renew-child:review-adult-information.preferred-notification-method-email') : t('renew-child:review-adult-information.preferred-notification-method-mail')}
                </p>
                <p>
                  <InlineLink id="change-communication-preference" routeId="public/renew/$id/child/communication-preference" params={params}>
                    {t('renew-child:review-adult-information.sun-life-comm-pref-change')}
                  </InlineLink>
                </p>
              </DescriptionListItem>
              <DescriptionListItem term={t('renew-child:review-adult-information.goc-comm-pref-title')}>
                <p>
                  {userInfo.communicationGOCPreference === PREFERRED_NOTIFICATION_METHOD.msca ? t('renew-child:review-adult-information.preferred-notification-method-msca') : t('renew-child:review-adult-information.preferred-notification-method-mail')}
                </p>
                <p>
                  <InlineLink id="change-communication-preference" routeId="public/renew/$id/child/communication-preference" params={params}>
                    {t('renew-child:review-adult-information.goc-comm-pref-change')}
                  </InlineLink>
                </p>
              </DescriptionListItem>
            </dl>
        ...
        <fetcher.Form method="post" onSubmit={handleSubmit} className="flex flex-row-reverse flex-wrap items-center justify-end gap-3">
          ...
          <div className="mt-8 flex flex-row-reverse flex-wrap items-center justify-end gap-3">
            ...
            <Button
              ...
              data-gc-analytics-customclick="ESDC-EDSC:CDCP Renew Application Form-Child:Back - Review your information click"
            >
