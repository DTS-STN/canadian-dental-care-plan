...
export async function loader({ context: { appContainer, session }, params, request }: Route.LoaderArgs) {
  ...
  instrumentationService.countHttpStatus('public.renew.child.children.update-federal-provincial-territorial-benefits', 200);
...
export async function action({ context: { appContainer, session }, params, request }: Route.ActionArgs) {
  ...
  if (formAction === FORM_ACTION.cancel) {
    ...
    instrumentationService.countHttpStatus('public.renew.child.children.update-federal-provincial-territorial-benefits', 302);
  ...
  if (!parsedFederalBenefitsResult.success || !parsedProvincialTerritorialBenefitsResult.success) {
    instrumentationService.countHttpStatus('public.renew.child.children.update-federal-provincial-territorial-benefits', 400);
    return data(
      {
        errors: {
