...
export async function loader({ context: { appContainer, session }, params, request }: Route.LoaderArgs) {
  ...
  instrumentationService.countHttpStatus('public.renew.child.children.confirm-federal-provincial-territorial-benefits', 200);
...
export async function action({ context: { appContainer, session }, params, request }: Route.ActionArgs) {
  ...
  if (!parsedDentalBenefitsResult.success) {
    instrumentationService.countHttpStatus('public.renew.child.children.confirm-federal-provincial-territorial-benefits', 400);
    return data(
      {
        errors: {
  ...
  instrumentationService.countHttpStatus('public.renew.child.children.confirm-federal-provincial-territorial-benefits', 302);
