...
export default function RenewChildReviewChildInformation({ loaderData, params }: Route.ComponentProps) {
        ...
        <fetcher.Form method="post" onSubmit={handleSubmit} className="flex flex-row-reverse flex-wrap items-center justify-end gap-3">
          ...
          <div className="mt-8 flex flex-row-reverse flex-wrap items-center justify-end gap-3">
            ...
            <Button
              ...
              data-gc-analytics-customclick="ESDC-EDSC:CDCP Renew Application Form-Child:Back - Review child(ren) information click"
            >
