...
export async function action({ context: { appContainer, session }, params, request }: Route.ActionArgs) {
  ...
  const dentalInsuranceSchema = z.object({
    dentalInsurance: z.boolean({ error: t('renew-adult:dental-insurance.error-message.dental-insurance-required') }),
  });
...
export default function RenewAdultAccessToDentalInsuranceQuestion({ loaderData, params }: Route.ComponentProps) {
          ...
          {editMode ? (
            ...
            <div className="mt-8 flex flex-row-reverse flex-wrap items-center justify-end gap-3">
              <LoadingButton
                ...
                data-gc-analytics-customclick="ESDC-EDSC:CDCP Renew Application Form-Adult:Continue - Access to private dental insurance click"
              >
