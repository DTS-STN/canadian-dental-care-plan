...
export default function RenewAdultReviewAdultInformation() {
      ...
      <div className="max-w-prose">
          ...
          <section className="space-y-6">
            ...
            <dl className="divide-y border-y">
              ...
              <DescriptionListItem term={t('renew-adult:review-adult-information.marital-title')}>
                <p>{userInfo.maritalStatus ? userInfo.maritalStatus : t('renew-adult:review-adult-information.no-change')}</p>
                <div className="mt-4">
          ...
          <section className="space-y-6">
            ...
            <dl className="divide-y border-y">
              ...
              <DescriptionListItem term={t('renew-adult:review-adult-information.mailing-title')}>
                ...
                <div className="mt-4">
                  <InlineLink id="change-mailing-address" routeId="public/renew/$id/adult/update-mailing-address" params={params}>
              ...
              <DescriptionListItem term={t('renew-adult:review-adult-information.home-title')}>
                ...
                <div className="mt-4">
                  <InlineLink id="change-home-address" routeId="public/renew/$id/adult/update-home-address" params={params}>
        ...
        <fetcher.Form onSubmit={handleSubmit} method="post" className="mt-8 flex flex-row-reverse flex-wrap items-center justify-end gap-3">
          ...
          <LoadingButton
            ...
            data-gc-analytics-customclick="ESDC-EDSC:CDCP Renew Application Form-Adult:Submit application- Review your information click"
          >
