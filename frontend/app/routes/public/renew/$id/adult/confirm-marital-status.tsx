...
export async function action({ context: { appContainer, session }, params, request }: Route.ActionArgs) {
  ...
  const confirmMaritalStatusSchema = z.object({
    hasMaritalStatusChanged: z.boolean({
      error: t('renew-adult:confirm-marital-status.error-message.has-marital-status-changed-required'),
    }),
  });
          ...
          {editMode ? (
            <div className="flex flex-wrap items-center gap-3">
              ...
              <ButtonLink
                ...
                data-gc-analytics-customclick="ESDC-EDSC:CDCP Renew Application Form-Adult:Cancel - Marital status click"
              >
