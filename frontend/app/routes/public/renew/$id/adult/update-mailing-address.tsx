...
export async function action({ context: { appContainer, session }, params, request }: Route.ActionArgs) {
  ...
  if (canProceedToDental) {
    ...
    if (state.editMode) {
      return redirect(isCopyMailingToHome ? getPathById('public/renew/$id/adult/review-adult-information', params) : getPathById('public/renew/$id/adult/update-home-address', params));
    }
...
export default function RenewAdultUpdateAddress({ loaderData, params }: Route.ComponentProps) {
        ...
        <fetcher.Form method="post" noValidate>
          ...
          {editMode ? (
            <div className="flex flex-wrap items-center gap-3">
              ...
              <Button id="cancel-button" name="_action" variant="secondary" disabled={isSubmitting} value={FORM_ACTION.cancel} data-gc-analytics-customclick="ESDC-EDSC:CDCP Renew Application Form-Adult:Cancel - Mailing address click">
