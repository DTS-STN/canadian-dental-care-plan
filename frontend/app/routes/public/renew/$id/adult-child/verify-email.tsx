      ...
      verificationCode: z
        ...
        .superRefine((val, ctx) => {
          if (state.verifyEmail && state.verifyEmail.verificationAttempts >= MAX_ATTEMPTS) {
            ctx.addIssue({ code: 'custom', message: t('renew-adult-child:verify-email.error-message.verification-code-max-attempts'), path: ['verificationCode'] });
          }
        }),
    });
...
export default function RenewFlowVerifyEmail({ loaderData, params }: Route.ComponentProps) {
  ...
  const communicationLink = <InlineLink routeId="public/renew/$id/adult-child/communication-preference" params={params} />;
      ...
      <div className="max-w-prose">
        ...
        <fetcher.Form method="post" noValidate>
          ...
          <fieldset className="mb-6">
            ...
            <p className="mb-8">
              <Trans ns={handle.i18nNamespaces} i18nKey="renew-adult-child:verify-email.unable-to-verify" components={{ communicationLink }} />
            </p>
          ...
          {editMode ? (
            <div className="flex flex-wrap items-center gap-3">
              <LoadingButton variant="primary" id="save-button" loading={isSubmitting} name="_action" value={FORM_ACTION.submit} data-gc-analytics-customclick="ESDC-EDSC:CDCP Renew Application Form-Adult_Child:Save - Verify email click">
              ...
              <ButtonLink
                ...
                data-gc-analytics-customclick="ESDC-EDSC:CDCP Renew Application Form-Adult_Child:Cancel - Verify email click"
              >
