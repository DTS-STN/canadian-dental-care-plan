  ...
  const childInformationSchema = z
    .object({
      ...
      dateOfBirthYear: z.number({
        error: (issue) => (issue.input === undefined ? t('renew-adult-child:children.information.error-message.date-of-birth-year-required') : t('renew-adult-child:children.information.error-message.date-of-birth-year-number')),
      }),
      dateOfBirthMonth: z.number({
        error: (issue) => (issue.input === undefined ? t('renew-adult-child:children.information.error-message.date-of-birth-month-required') : undefined),
      }),
      dateOfBirthDay: z.number({
        error: (issue) => (issue.input === undefined ? t('renew-adult-child:children.information.error-message.date-of-birth-day-required') : t('renew-adult-child:children.information.error-message.date-of-birth-day-number')),
      }),
