...
export async function loader({ context: { appContainer, session }, request, params }: Route.LoaderArgs) {
  ...
  const meta = {
    title: t('gcweb:meta.title.template', { title: t('renew-adult-child:children.demographic-survey.page-title', { memberName }) }),
    dcTermsTitle: t('gcweb:meta.title.template', { title: t('renew-adult-child:children.demographic-survey.page-title', { memberName: childNumber }) }),
  };
  ...
  instrumentationService.countHttpStatus('public.renew.adult-child.children.demographic-survey', 200);
...
export async function action({ context: { appContainer, session }, params, request }: Route.ActionArgs) {
  ...
  if (!parsedDataResult.success) {
    instrumentationService.countHttpStatus('public.renew.adult-child.children.demographic-survey', 400);
  ...
  instrumentationService.countHttpStatus('public.renew.adult-child.children.demographic-survey', 302);
...
export default function RenewAdultChildChildrenDemographicSurveyQuestions({ loaderData, params }: Route.ComponentProps) {
