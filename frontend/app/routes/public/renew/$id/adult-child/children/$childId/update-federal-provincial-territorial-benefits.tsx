...
export default function RenewAdultChildUpdateFederalProvincialTerritorialBenefits() {
  ...
  const { csrfToken, federalSocialPrograms, provincialTerritorialSocialPrograms, provinceTerritoryStates, defaultFederalState, defaultProvincialTerritorialState, childName, editMode, federalBenefitsChanged, provincialTerritorialBenefitsChanged } =
