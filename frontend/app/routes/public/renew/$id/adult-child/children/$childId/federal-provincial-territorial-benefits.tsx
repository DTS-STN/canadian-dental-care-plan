...
export const handle = {
  ...
  pageIdentifier: pageIds.public.renew.adultChild.childFederalProvincialTerritorialBenefits,
...
export async function action({ context: { session }, params, request }: ActionFunctionArgs) {
  ...
  const federalBenefitsSchema = z
    .object({
      hasFederalBenefits: z.boolean({ errorMap: () => ({ message: t('renew-adult-child:children.dental-benefits.error-message.federal-benefit-required') }) }),
    ...
    .superRefine((val, ctx) => {
      if (val.hasFederalBenefits) {
        if (!val.federalSocialProgram || validator.isEmpty(val.federalSocialProgram)) {
          ctx.addIssue({ code: z.ZodIssueCode.custom, message: t('renew-adult-child:children.dental-benefits.error-message.federal-benefit-program-required'), path: ['federalSocialProgram'] });
        }
      }
    })
    .transform((val) => {
  ...
  const provincialTerritorialBenefitsSchema = z
    .object({
      hasProvincialTerritorialBenefits: z.boolean({ errorMap: () => ({ message: t('renew-adult-child:children.dental-benefits.error-message.provincial-benefit-required') }) }),
    ...
    .superRefine((val, ctx) => {
      if (val.hasProvincialTerritorialBenefits) {
        if (!val.province || validator.isEmpty(val.province)) {
          ctx.addIssue({ code: z.ZodIssueCode.custom, message: t('renew-adult-child:children.dental-benefits.error-message.provincial-territorial-required'), path: ['province'] });
        } else if (!val.provincialTerritorialSocialProgram || validator.isEmpty(val.provincialTerritorialSocialProgram)) {
          ctx.addIssue({ code: z.ZodIssueCode.custom, message: t('renew-adult-child:children.dental-benefits.error-message.provincial-benefit-program-required'), path: ['provincialTerritorialSocialProgram'] });
        }
      }
    })
    .transform((val) => {
  ...
  return (
    <>
      ...
      <div className="max-w-prose">
        <p className="mb-4">{t('renew-adult-child:children.dental-benefits.access-to-dental')}</p>
        <p className="mb-4">{t('renew-adult-child:children.dental-benefits.eligibility-criteria')}</p>
        ...
        <fetcher.Form method="post" noValidate>
              ...
              options={[
                {
                  ...
                  append: hasFederalBenefitValue === true && (
                    <InputRadios
                      ...
                      legend={t('renew-adult-child:children.dental-benefits.federal-benefits.social-programs.legend')}
                ...
                {
                  children: <Trans ns={handle.i18nNamespaces} i18nKey="renew-adult-child:children.dental-benefits.federal-benefits.option-no" />,
          ...
          <fieldset className="mb-8">
            <legend className="mb-4 font-lato text-2xl font-bold">{t('renew-adult-child:children.dental-benefits.provincial-territorial-benefits.title')}</legend>
            <InputRadios
              ...
              options={[
                  ...
                  append: hasProvincialTerritorialBenefitValue === true && (
                    <div className="space-y-6">
                      <InputSelect
                        ...
                        label={t('renew-adult-child:children.dental-benefits.provincial-territorial-benefits.social-programs.input-legend')}
                        onChange={handleOnRegionChanged}
                        options={[
                          {
                            children: t('renew-adult-child:children.dental-benefits.select-one'),
                            value: '',
                            hidden: true,
                          },
                      ...
                      {provinceValue && (
                        <InputRadios
                          ...
                          legend={t('renew-adult-child:children.dental-benefits.provincial-territorial-benefits.social-programs.radio-legend')}
                          legendClassName="font-normal"
                ...
                {
                  children: <Trans ns={handle.i18nNamespaces} i18nKey="renew-adult-child:children.dental-benefits.provincial-territorial-benefits.option-no" />,
          ...
          {editMode ? (
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <Button variant="primary" id="continue-button" disabled={isSubmitting} data-gc-analytics-customclick="ESDC-EDSC:CDCP Renew Application Form-Adult-ChildSave - Federal provincial or territorial benefits click">
                {t('renew-adult-child:children.dental-benefits.button.save-btn')}
              </Button>
              <ButtonLink
                id="back-button"
                ...
                data-gc-analytics-customclick="ESDC-EDSC:CDCP Renew Application Form-Adult-ChildCancel - Federal provincial or territorial benefits click"
              >
                {t('renew-adult-child:children.dental-benefits.button.cancel-btn')}
              </ButtonLink>
            </div>
          ) : (
            <div className="mt-8 flex flex-row-reverse flex-wrap items-center justify-end gap-3">
              <LoadingButton
                ...
                data-gc-analytics-customclick="ESDC-EDSC:CDCP Renew Application Form-Adult-ChildContinue - Federal provincial or territorial benefits click"
              >
                {t('renew-adult-child:children.dental-benefits.button.continue')}
              </LoadingButton>
              <ButtonLink
                id="back-button"
                ...
                data-gc-analytics-customclick="ESDC-EDSC:CDCP Renew Application Form-Adult-ChildBack - Federal provincial or territorial benefits click"
              >
                {t('renew-adult-child:children.dental-benefits.button.back')}
              </ButtonLink>
            </div>
          )}
        </fetcher.Form>
