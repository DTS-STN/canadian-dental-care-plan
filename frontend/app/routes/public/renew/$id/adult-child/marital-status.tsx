...
export async function action({ context: { appContainer, session }, params, request }: Route.ActionArgs) {
  ...
  const partnerInformationSchema = z.object({
    ...
    yearOfBirth: z
      ...
      .refine((year) => Number.parseInt(year) > currentYear - 150, t('renew-adult-child:marital-status.error-message.yob-is-past'))
      .refine((year) => Number.parseInt(year) < currentYear, t('renew-adult-child:marital-status.error-message.yob-is-future')),
...
export default function RenewAdultChildMaritalStatus({ loaderData, params }: Route.ComponentProps) {
        ...
        <fetcher.Form method="post" noValidate>
          ...
          {editMode ? (
            <div className="flex flex-wrap items-center gap-3">
              ...
              <LoadingButton id="cancel-button" variant="secondary" name="_action" value={FORM_ACTION.cancel} disabled={isSubmitting} data-gc-analytics-customclick="ESDC-EDSC:CDCP Renew Application Form-Adult_Child:Cancel - Marital status click">
            ...
            <div className="flex flex-row-reverse flex-wrap items-center justify-end gap-3">
              <LoadingButton
                ...
                data-gc-analytics-customclick="ESDC-EDSC:CDCP Renew Application Form-Adult_Child:Continue - Marital status click"
              >
              ...
              <ButtonLink
                ...
                data-gc-analytics-customclick="ESDC-EDSC:CDCP Renew Application Form-Adult_Child:Back - Marital status click"
              >
