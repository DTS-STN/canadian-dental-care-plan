...
export async function action({ context: { appContainer, session }, params, request }: Route.ActionArgs) {
  ...
  const confirmAddressSchema = z.object({
    hasAddressChanged: z.enum(ADDRESS_RADIO_OPTIONS, {
      error: t('renew-adult-child:confirm-address.error-message.has-address-changed-required'),
    }),
  });
          ...
          {editMode ? (
            <div className="mt-8 flex flex-wrap items-center gap-3">
              ...
              <ButtonLink
                ...
                data-gc-analytics-customclick="ESDC-EDSC:CDCP Renew Application Form-Adult_Child:Cancel - Address click"
              >
