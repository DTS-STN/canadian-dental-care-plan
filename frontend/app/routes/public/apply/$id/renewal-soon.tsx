...
export const handle = {
  ...
  pageIdentifier: pageIds.public.apply.renewalSoon,
...
export default function ApplyFlowRenewalSoon({ loaderData, params }: Route.ComponentProps) {
    ...
    <div className="max-w-prose">
      ...
      <fetcher.Form method="post" noValidate className="flex flex-wrap items-center gap-3">
        ...
        <ButtonLink
          ...
          data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form:Back - Renewal soon click"
        >
          {t('apply:renewal-soon.back-btn')}
        </ButtonLink>
        <LoadingButton variant="primary" loading={isSubmitting} data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form:Exit - Renewal soon click">
