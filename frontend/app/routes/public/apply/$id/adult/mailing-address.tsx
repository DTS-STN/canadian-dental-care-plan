...
export const handle = {
  ...
  pageTitleI18nKey: 'apply-adult:address.mailing-address.page-title',
...
export default function ApplyAdultMailingAddress({ loaderData, params }: Route.ComponentProps) {
          ...
          <fieldset className="mb-6">
            <div className="space-y-6">
              ...
              <InputCheckbox id="sync-addresses" name="syncAddresses" value="true" checked={copyAddressChecked} onChange={checkHandler}>
                {t('apply-adult:address.home-address.use-mailing-address')}
              </InputCheckbox>
            </div>
          </fieldset>
          {editMode ? (
            <div className="flex flex-wrap items-center gap-3">
              ...
              <Button id="cancel-button" name="_action" variant="secondary" disabled={isSubmitting} value={FORM_ACTION.cancel} data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form-Adult:Cancel - Mailing address click">
