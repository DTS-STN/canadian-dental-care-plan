...
export const handle = {
  ...
  pageIdentifier: pageIds.public.apply.adult.contactInformation,
    ...
    .superRefine((val, ctx) => {
      if (val.email ?? val.confirmEmail) {
        ...
        if (typeof val.confirmEmail !== 'string' || validator.isEmpty(val.confirmEmail)) {
          ...
          ctx.addIssue({ code: z.ZodIssueCode.custom, message: t('apply-adult:contact-information.error-message.confirm-email-valid'), path: ['confirmEmail'] });
      ...
      <div className="max-w-prose">
        ...
        <fetcher.Form method="post" noValidate>
          ...
          <fieldset className="mb-6">
            <legend className="font-lato mb-4 text-2xl font-bold">{t('apply-adult:contact-information.phone-header')}</legend>
          ...
          <fieldset className="mb-6">
            <legend className="font-lato mb-4 text-2xl font-bold">{t('apply-adult:contact-information.email-header')}</legend>
          ...
          <fieldset className="mb-6">
            <legend className="font-lato mb-4 text-2xl font-bold">{t('apply-adult:contact-information.mailing-address.header')}</legend>
          ...
          <fieldset className="mb-8">
            <legend className="font-lato mb-4 text-2xl font-bold">{t('apply-adult:contact-information.home-address.header')}</legend>
            <div className="space-y-6">
          ...
          {editMode ? (
            <div className="flex flex-wrap items-center gap-3">
              ...
              <ButtonLink id="back-button" routeId="public/apply/$id/adult/review-information" params={params} disabled={isSubmitting} data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form-Adult:Cancel - Contact information click">
            ...
            <div className="flex flex-row-reverse flex-wrap items-center justify-end gap-3">
              ...
              <ButtonLink
                id="back-button"
                routeId={[MARITAL_STATUS_CODE_COMMONLAW, MARITAL_STATUS_CODE_MARRIED].includes(Number(maritalStatus)) ? 'public/apply/$id/adult/partner-information' : 'public/apply/$id/adult/applicant-information'}
                params={params}
