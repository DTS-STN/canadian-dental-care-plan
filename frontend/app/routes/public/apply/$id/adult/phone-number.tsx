...
export async function action({ context: { appContainer, session }, params, request }: Route.ActionArgs) {
  ...
  appContainer.get(TYPES.domain.services.AuditService).createAudit('update-data.renew.phone-number', { userId: idToken.sub });

  if (state.editMode) {
    return redirect(getPathById('public/apply/$id/review-adult-information', params));
  }
