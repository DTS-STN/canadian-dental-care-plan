...
export const handle = {
  ...
  pageIdentifier: pageIds.public.apply.adultChild.partnerInformation,
  ...
  const partnerInformationSchema = z
    ...
    .superRefine((val, ctx) => {
      ...
      if (!isValidDateString(dateOfBirth)) {
        ctx.addIssue({ code: z.ZodIssueCode.custom, message: t('apply-adult-child:partner-information.error-message.date-of-birth-valid'), path: ['dateOfBirth'] });
      } else if (!isPastDateString(dateOfBirth)) {
        ctx.addIssue({ code: z.ZodIssueCode.custom, message: t('apply-adult-child:partner-information.error-message.date-of-birth-is-past'), path: ['dateOfBirth'] });
      } else if (getAgeFromDateString(dateOfBirth) > 150) {
        ctx.addIssue({ code: z.ZodIssueCode.custom, message: t('apply-adult-child:partner-information.error-message.date-of-birth-is-past-valid'), path: ['dateOfBirth'] });
      }
    })
    .transform((val) => {
      // At this point the year, month and day should have been validated as positive integer
        ...
        <fetcher.Form method="post" noValidate>
          ...
          <div className="space-y-6">
            ...
            <div className="grid items-end gap-6 md:grid-cols-2">
              <InputSanitizeField
                ...
                name="firstName"
                className="w-full"
                label={t('apply-adult-child:partner-information.first-name')}
                maxLength={100}
              ...
              <InputSanitizeField
                ...
                name="lastName"
                className="w-full"
                label={t('apply-adult-child:partner-information.last-name')}
                maxLength={100}
          ...
          {editMode ? (
            <div className="mt-8 flex flex-wrap items-center gap-3">
              ...
              <ButtonLink
                id="back-button"
                routeId={defaultState ? 'public/apply/$id/adult-child/review-adult-information' : 'public/apply/$id/adult-child/applicant-information'}
                params={params}
            ...
            <div className="mt-8 flex flex-row-reverse flex-wrap items-center justify-end gap-3">
              <LoadingButton
                ...
                data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form-Adult_Child:Continue - Spouse or common-law partner information click"
              >
