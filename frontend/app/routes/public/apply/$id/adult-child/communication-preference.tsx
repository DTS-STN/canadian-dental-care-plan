...
export default function ApplyFlowCommunicationPreferencePage({ loaderData, params }: Route.ComponentProps) {
  ...
  const nonEmailOptions: InputRadiosProps['options'] = preferredCommunicationMethods
    ...
    .map((method) => ({
      children: <strong>{t('apply-adult-child:communication-preference.by-mail')}</strong>,
      value: method.id,
  ...
  const options: InputRadiosProps['options'] = [
    {
      children: <strong>{t('apply-adult-child:communication-preference.by-email')}</strong>,
