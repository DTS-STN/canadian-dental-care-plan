...
import { loadApplyAdultChildState } from '~/.server/routes/helpers/apply-adult-child-child-route-helpers';
...
export const handle = {
  i18nNamespaces: getTypedI18nNamespaces('apply-adult-child-child', 'apply', 'gcweb'),
