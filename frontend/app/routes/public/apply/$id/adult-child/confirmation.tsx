      ...
      <section>
        <ContextualAlert type="comment">
          <div className="space-y-4">
            ...
            <ButtonLink id="survey-button" to={surveyLink} params={params} target="_blank" data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form-Adult_Child:Confirmation survey button - Take the survey click" variant="primary">
      ...
      <section className="space-y-8">
        ...
        <section className="space-y-6">
          ...
          <dl className="divide-y border-y">
            ...
            <DescriptionListItem term={t('confirm.marital-status')}>{userInfo.maritalStatus ? t(`apply-adult-child:${maritalStatusMap[userInfo.maritalStatus as keyof typeof maritalStatusMap]}`) : ''}</DescriptionListItem>
