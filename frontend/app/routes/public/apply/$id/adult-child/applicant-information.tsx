  ...
  const applicantInformationSchema = z
    .object({
      socialInsuranceNumber: z
        ...
        .superRefine((sin, ctx) => {
          if (!isValidSin(sin)) {
            ctx.addIssue({ code: 'custom', message: t('apply-adult-child:applicant-information.error-message.sin-valid') });
          } else if (
            ...
            ctx.addIssue({ code: 'custom', message: t('apply-adult-child:children.information.error-message.sin-unique') });
          }
        }),
      firstName: z
        .string()
