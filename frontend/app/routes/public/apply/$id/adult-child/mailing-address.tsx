...
export const handle = {
  ...
  pageTitleI18nKey: 'apply-adult-child:address.mailing-address.page-title',
...
export async function action({ context: { appContainer, session }, params, request }: Route.ActionArgs) {
  ...
  if (canProceedToDental) {
    ...
    return redirect(isCopyMailingToHome ? getPathById('public/apply/$id/adult-child/dental-insurance', params) : getPathById('public/apply/$id/adult-child/home-address', params));
  }
...
export default function ApplyAdultChildMailingAddress({ loaderData, params }: Route.ComponentProps) {
  ...
  const dummyOption: InputOptionProps = { children: t('apply-adult-child:address.address-field.select-one'), value: '' };
          ...
          <fieldset className="mb-6">
            <div className="space-y-6">
              <InputSanitizeField
                ...
                name="address"
                className="w-full"
                label={t('apply-adult-child:address.address-field.address')}
                maxLength={100}
                helpMessagePrimary={t('apply-adult-child:address.address-field.address-note')}
              ...
              <div className="grid items-end gap-6 md:grid-cols-2">
                <InputSanitizeField
                  ...
                  name="city"
                  className="w-full"
                  label={t('apply-adult-child:address.address-field.city')}
                  maxLength={100}
                ...
                <InputSanitizeField
                  ...
                  name="postalZipCode"
                  className="w-full"
                  label={isPostalCodeRequired ? t('apply-adult-child:address.address-field.postal-code') : t('apply-adult-child:address.address-field.postal-code-optional')}
                  maxLength={100}
              ...
              {mailingRegions.length > 0 && (
                <InputSelect
                  ...
                  label={t('apply-adult-child:address.address-field.province')}
              ...
              <InputSelect
                ...
                name="countryId"
                className="w-full sm:w-1/2"
                label={t('apply-adult-child:address.address-field.country')}
              ...
              <InputCheckbox id="sync-addresses" name="syncAddresses" value="true" checked={copyAddressChecked} onChange={checkHandler}>
                {t('apply-adult-child:address.home-address.use-mailing-address')}
              </InputCheckbox>
            </div>
          </fieldset>
          {editMode ? (
