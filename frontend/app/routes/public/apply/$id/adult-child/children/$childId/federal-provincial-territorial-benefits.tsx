...
export async function loader({ context: { serviceProvider, session }, params, request }: LoaderFunctionArgs) {
  ...
  const provincialTerritorialSocialPrograms = localizeAndSortProvincialGovernmentInsurancePlans(serviceProvider.getProvincialGovernmentInsurancePlanService().listPlans(), locale);
