...
export async function action({ context: { appContainer, session }, params, request }: Route.ActionArgs) {
  ...
  if (!parsedDataResult.success) {
    instrumentationService.countHttpStatus('public.apply.child.email', 400);
  ...
  instrumentationService.countHttpStatus('public.apply.child.email', 302);
          ...
          <fieldset className="mb-6">
            ...
            <div className="grid items-end gap-6 md:grid-cols-2">
              <InputField
                ...
                label={t('apply-child:email.email-legend')}
                maxLength={64}
