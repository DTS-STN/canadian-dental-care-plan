...
export async function loader({ context: { serviceProvider, session }, params, request }: LoaderFunctionArgs) {
  ...
  const children = state.children.map((child) => {
    ...
    const selectedProvincialBenefit = child.dentalBenefits.provincialTerritorialSocialProgram ? serviceProvider.getProvincialGovernmentInsurancePlanService().getPlanById(child.dentalBenefits.provincialTerritorialSocialProgram) : undefined;
                ...
                <div>
                  ...
                  <dl className="divide-y border-y">
                    ...
                    <DescriptionListItem term={t('apply-child:review-child-information.dental-benefit-title')}>
                      ...
                      <p className="mt-4">
                        <InlineLink id="change-dental-benefits" routeId="public/apply/$id/child/children/$childId/federal-provincial-territorial-benefits" params={childParams}>
