...
export const handle = {
  ...
  pageIdentifier: pageIds.public.apply.child.homeAddress,
  pageTitleI18nKey: 'apply-child:address.home-address.page-title',
...
export async function action({ context: { appContainer, session }, params, request }: Route.ActionArgs) {
  ...
  if (formAction === FORM_ACTION.cancel) {
    instrumentationService.countHttpStatus('public.apply.child.home-address', 302);
  ...
  if (!parsedDataResult.success) {
    instrumentationService.countHttpStatus('public.apply.child.home-address', 400);
  ...
  if (canProceedToDental) {
    ...
    return redirect(getPathById('public/apply/$id/child/phone-number', params));
  }
  ...
  if (addressCorrectionResult.status === 'not-correct') {
    instrumentationService.countHttpStatus('public.apply.child.home-address.address-invalid', 200);
    return {
  ...
  if (addressCorrectionResult.status === 'corrected') {
    ...
    instrumentationService.countHttpStatus('public.apply.child.home-address.address-suggestion', 200);
    return {
...
export default function ApplyChildHomeAddress({ loaderData, params }: Route.ComponentProps) {
  ...
  const dummyOption: InputOptionProps = { children: t('apply-child:address.address-field.select-one'), value: '' };
        ...
        <fetcher.Form method="post" noValidate>
          ...
          <fieldset className="mb-8">
            <div className="space-y-6">
              <InputSanitizeField
                ...
                name="address"
                className="w-full"
                label={t('apply-child:address.address-field.address')}
                helpMessagePrimary={t('apply-child:address.address-field.address-note')}
              ...
              <div className="mb-6 grid items-end gap-6 md:grid-cols-2">
                <InputSanitizeField
                  ...
                  name="city"
                  className="w-full"
                  label={t('apply-child:address.address-field.city')}
                  maxLength={100}
                ...
                <InputSanitizeField
                  ...
                  name="postalZipCode"
                  className="w-full"
                  label={isPostalCodeRequired ? t('apply-child:address.address-field.postal-code') : t('apply-child:address.address-field.postal-code-optional')}
                  maxLength={100}
              ...
              {homeRegions.length > 0 && (
                <InputSelect
                  ...
                  label={t('apply-child:address.address-field.province')}
              ...
              <InputSelect
                ...
                name="countryId"
                className="w-full sm:w-1/2"
                label={t('apply-child:address.address-field.country')}
          ...
          {editMode ? (
            ...
            <div className="flex flex-row-reverse flex-wrap items-center justify-end gap-3">
              ...
              <ButtonLink
                id="back-button"
                routeId={`public/apply/$id/child/mailing-address`}
                params={params}
