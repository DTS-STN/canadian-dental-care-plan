              ...
              <Card className="my-2">
                ...
                <CardFooter className="border-t bg-zinc-100">
                  <ButtonLink
                    ...
                    size="lg"
                  >
                    {child.dentalInsurance === undefined ? t('application-simplified-child:childrens-application.add-answer') : t('application-simplified-child:childrens-application.edit-child-dental-insurance', { childNumber: index + 1 })}
                  </ButtonLink>
                </CardFooter>
              </Card>
              ...
              <Card className="my-2">
                ...
                <CardFooter className="border-t bg-zinc-100">
                  <ButtonLink
                    ...
                    size="lg"
                  >
                    {child.dentalBenefits === undefined ? t('application-simplified-child:childrens-application.add-answer') : t('application-simplified-child:childrens-application.edit-child-dental-benefits', { childNumber: index + 1 })}
                  </ButtonLink>
                </CardFooter>
              </Card>
