              ...
              <CardContent>
                {child.information === undefined ? (
                  ...
                  <dl className="divide-y border-y">
                    <DescriptionListItem term={t('application-new-family:childrens-application.member-id-title')}>
                      <p>{child.id}</p>
                    </DescriptionListItem>
                    <DescriptionListItem term={t('application-new-family:childrens-application.full-name-title')}>
                      <p>{childName}</p>
                    </DescriptionListItem>
                    <DescriptionListItem term={t('application-new-family:childrens-application.dob-title')}>
                      <p>{dateOfBirth}</p>
                    </DescriptionListItem>
                    <DescriptionListItem term={t('application-new-family:childrens-application.sin-title')}>
                      <p>{child.information.socialInsuranceNumber ? formatSin(child.information.socialInsuranceNumber) : ''}</p>
                    </DescriptionListItem>
                    <DescriptionListItem term={t('application-new-family:childrens-application.parent-guardian-title')}>
            ...
            <Card className="my-2">
              ...
              <CardContent>
                {child.dentalInsurance === undefined ? (
                  ...
                  <dl className="divide-y border-y">
                    <DescriptionListItem term={t('application-new-family:childrens-application.dental-insurance-title')}>
