        ...
        <CardContent className="space-y-6">
          {defaultState.typeOfApplication === undefined ? (
            ...
            <DefinitionList layout="single-column">
              <DefinitionListItem className="sm:grid-cols-none" term={t('application:your-application.type-application-legend')}>
          ...
          {defaultState.personalInformation === undefined ? (
            ...
            <DefinitionList layout="single-column">
              {defaultState.personalInformation.memberId && (
                <DefinitionListItem className="sm:grid-cols-none" term={t('application:your-application.member-id')}>
                  {formatClientNumber(defaultState.personalInformation.memberId)}
                </DefinitionListItem>
              )}
              <DefinitionListItem className="sm:grid-cols-none" term={t('application:your-application.full-name')}>
                {`${defaultState.personalInformation.firstName} ${defaultState.personalInformation.lastName}`}
              </DefinitionListItem>
              <DefinitionListItem className="sm:grid-cols-none" term={t('application:your-application.date-of-birth')}>
                {formattedDate}
              </DefinitionListItem>
