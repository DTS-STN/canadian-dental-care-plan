    ...
    <div className="max-w-prose space-y-10">
          ...
          {children.map((child) => {
            ...
            return (
              <section key={child.id} className="space-y-10">
                ...
                <div>
                  <h3 className="font-lato mb-6 text-2xl font-bold">{t('application-simplified-family:confirm.page-sub-title', { child: child.firstName })}</h3>
                  <DefinitionList border>
                    <DefinitionListItem term={t('confirm.member-id')}>{child.memberId}</DefinitionListItem>
                    <DefinitionListItem term={t('application-simplified-family:confirm.full-name')}>{`${child.firstName} ${child.lastName}`}</DefinitionListItem>
                    ...
                    <DefinitionListItem term={t('application-simplified-family:confirm.is-parent')}>{child.isParent ? t('application-simplified-family:confirm.yes') : t('application-simplified-family:confirm.no')}</DefinitionListItem>
                  </DefinitionList>
                </div>
                <div>
                  <h3 className="font-lato mb-6 text-2xl font-bold">{t('application-simplified-family:confirm.dental-title', { child: child.firstName })}</h3>
                  <DefinitionList border>
                    <DefinitionListItem term={t('application-simplified-family:confirm.dental-private')}>
                    ...
                    <DefinitionListItem term={t('application-simplified-family:confirm.dental-public')}>
                      {child.dentalInsurance.haveDentalBenefitsChanged && (child.dentalInsurance.federalBenefit.access || child.dentalInsurance.provTerrBenefit.access) ? (
                        ...
                        <p>{child.dentalInsurance.haveDentalBenefitsChanged ? t('application-simplified-family:confirm.no') : t('application-simplified-family:confirm.no-update')}</p>
                      )}
                    </DefinitionListItem>
                  </DefinitionList>
                </div>
      ...
      <Dialog>
        ...
        <DialogContent aria-describedby={undefined} className="sm:max-w-md">
          ...
          <p>{t('application-simplified-family:confirm.modal.are-you-sure')}</p>
          <DialogFooter>
            <DialogClose asChild>
              <Button id="confirm-modal-back" variant="secondary" size="sm" data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form-Simplified_Family:Back exit modal - Application successfully submitted click">
                {t('application-simplified-family:confirm.modal.back-btn')}
              </Button>
            </DialogClose>
            <fetcher.Form method="post" noValidate>
              ...
              >
                {t('application-simplified-family:confirm.modal.close-btn')}
              </Button>
            </fetcher.Form>
          </DialogFooter>
        </DialogContent>
