...
export default function RenewFamilyChildrensApplication({ loaderData, params }: Route.ComponentProps) {
  ...
  const { steps, currentStep } = useProgressStepper('simplified-family', 'childrens-application');
  ...
  return (
    <div className="max-w-prose space-y-8">
      ...
      <div className="flex flex-row-reverse flex-wrap items-center justify-end gap-3">
        ...
        <NavigationButtonLink variant="secondary" direction="previous" routeId="public/application/$id/simplified-family/dental-insurance" params={params}>
