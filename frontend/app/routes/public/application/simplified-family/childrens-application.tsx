          ...
          return (
            <div key={child.id}>
              ...
              <Card className="my-2">
                <CardHeader>
                  <CardTitle asChild>
                    <h2>{t('application-simplified-family:childrens-application.child-information-card-title', { childNumber: index + 1 })}</h2>
                  </CardTitle>
              ...
              <Card className="my-2">
                <CardHeader>
                  <CardTitle asChild>
                    <h2>{t('application-simplified-family:childrens-application.child-dental-insurance-card-title')}</h2>
                  </CardTitle>
              ...
              <Card className="my-2">
                <CardHeader>
                  <CardTitle asChild>
                    <h2>{t('application-simplified-family:childrens-application.child-dental-benefits-card-title')}</h2>
                  </CardTitle>
                  ...
                  <CardFooter className="divide-y border-t bg-zinc-100 px-0">
                    ...
                    <fetcher.Form method="post" noValidate>
                      ...
                      <div className="w-full px-6">
                        ...
                        >
                          <span className="text-left">{t('application-simplified-family:childrens-application.benefits-not-changed')}</span>
                        </Button>
                      </div>
                    </fetcher.Form>
                  </CardFooter>
