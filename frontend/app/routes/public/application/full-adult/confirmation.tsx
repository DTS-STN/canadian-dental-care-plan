...
export const handle = {
  ...
  pageTitleI18nKey: 'application-full-adult:confirm.page-title',
...
export async function loader({ context: { appContainer, session }, params, request }: Route.LoaderArgs) {
  ...
  const meta = { title: t('gcweb:meta.title.template', { title: t('application-full-adult:confirm.page-title') }) };
    ...
    <div className="max-w-prose space-y-10">
              ...
              <DefinitionListItem term={t('confirm.dental-public')}>
                {dentalInsurance.selectedFederalBenefits || dentalInsurance.selectedProvincialBenefits ? (
                  <div className="space-y-3">
                    ...
                    <p>{t('application-full-adult:confirm.dental-benefit-has-access')}</p>
                    <ul className="list-disc space-y-1 pl-7">
      ...
      <Dialog>
        <DialogTrigger className="print:hidden" data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form-Full_Adult:Exit - Application successfully submitted click" asChild>
          <Button variant="secondary">{t('application-full-adult:confirm.close-application')}</Button>
        </DialogTrigger>
