        ...
        <CardContent>
          {state.dentalInsurance?.dentalInsuranceEligibilityConfirmation === true ? (
            <DefinitionList layout="single-column">
              <DefinitionListItem term={t('application-new-adult:dental-insurance.access-to-dental-insurance-or-coverage')}>
                {state.dentalInsurance.hasDentalInsurance ? t('application-new-adult:dental-insurance.dental-insurance-yes') : t('application-new-adult:dental-insurance.dental-insurance-no')}
              </DefinitionListItem>
            </DefinitionList>
          ) : (
      ...
      <Card>
        ...
        <CardContent>
          {state.dentalBenefits ? (
            <DefinitionList layout="single-column">
              <DefinitionListItem term={t('application-new-adult:dental-insurance.access-to-government-benefits')}>
                {state.dentalBenefits.federalBenefit.access || state.dentalBenefits.provTerrBenefit.access ? (
                  <div className="space-y-3">
                    <p>{t('application-new-adult:dental-insurance.access-to-government-benefits-yes')}</p>
                  ...
                  <p>{t('application-new-adult:dental-insurance.access-to-government-benefits-no')}</p>
                )}
              </DefinitionListItem>
            </DefinitionList>
          ) : (
