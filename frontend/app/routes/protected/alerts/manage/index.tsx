...
export async function action({ context: { session }, params, request }: ActionFunctionArgs) {
  ...
  return redirect(getPathById('protected/alerts/subscribe/confirm', params));
}
...
export default function ManageAlerts() {
  ...
  const unsubscribelink = <InlineLink routeId="protected/alerts/unsubscribe/index" params={params} data-gc-analytics-customclick="ESDC-EDSC:CDCP Alerts:Unsubscribe from CDCP email alerts - Manage CDCP email alerts click" />;
