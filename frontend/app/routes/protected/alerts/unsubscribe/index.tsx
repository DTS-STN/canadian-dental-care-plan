...
export async function loader({ context: { session }, params, request }: LoaderFunctionArgs) {
  ...
  if (!alertSubscription) {
    ...
    return redirect(getPathById('protected/alerts/index', params));
  }
...
export async function action({ context: { session }, params, request }: ActionFunctionArgs) {
  ...
  return redirect(getPathById('protected/alerts/unsubscribe/success', params));
}
    ...
    <div className="max-w-prose">
      ...
      <fetcher.Form method="post" noValidate>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <ButtonLink id="cancel-button" routeId="protected/alerts/manage/index" params={params} disabled={isSubmitting} data-gc-analytics-customclick="ESDC-EDSC:CDCP Alerts:Cancel - Unsubscribe from CDCP email alerts click">
