...
export const handle = {
  i18nNamespaces: getTypedI18nNamespaces('protected-application-full-family', 'protected-application', 'gcweb', 'common'),
  pageIdentifier: pageIds.protected.application.fullFamily.childApplication,
  pageTitleI18nKey: 'protected-application-full-family:childrens-application.page-title',
...
export async function loader({ context: { appContainer, session }, request, params }: Route.LoaderArgs) {
  ...
  const meta = { title: t('gcweb:meta.title.template', { title: t('protected-application-full-family:childrens-application.page-title') }) };
      ...
      <div className="max-w-prose space-y-8">
        {state.children.map((child, index) => {
          ...
          return (
            <div key={child.id}>
              ...
              <Card className="my-2">
                <CardHeader>
                  <CardTitle>{t('protected-application-full-family:childrens-application.child-information-card-title', { childNumber: index + 1 })}</CardTitle>
                  <CardAction>{sections.childInformation.completed && <StatusTag status="complete" />}</CardAction>
                </CardHeader>
                <CardContent>
                  {child.information === undefined ? (
                    <p>{t('protected-application-full-family:childrens-application.child-information-indicate-status')}</p>
                  ) : (
                    <DefinitionList layout="single-column">
                      {child.information.memberId && (
                        <DefinitionListItem term={t('protected-application-full-family:childrens-application.member-id-title')}>
                          <p>{child.information.memberId}</p>
                        </DefinitionListItem>
                      )}
                      <DefinitionListItem term={t('protected-application-full-family:childrens-application.full-name-title')}>
                        <p>{childName}</p>
                      </DefinitionListItem>
                      <DefinitionListItem term={t('protected-application-full-family:childrens-application.dob-title')}>
                        <p>{dateOfBirth}</p>
                      </DefinitionListItem>
                      <DefinitionListItem term={t('protected-application-full-family:childrens-application.sin-title')}>
                        <p>{child.information.socialInsuranceNumber ? formatSin(child.information.socialInsuranceNumber) : ''}</p>
                      </DefinitionListItem>
                      <DefinitionListItem term={t('protected-application-full-family:childrens-application.parent-guardian-title')}>
                        <p>{child.information.isParent ? t('protected-application-full-family:childrens-application.yes') : t('protected-application-full-family:childrens-application.no')}</p>
                      </DefinitionListItem>
                    </DefinitionList>
                  )}
                </CardContent>
                <CardFooter className="border-t bg-zinc-100">
                  <ButtonLink
                    ...
                    size="lg"
                  >
                    {child.information === undefined ? t('protected-application-full-family:childrens-application.add-child-information') : t('protected-application-full-family:childrens-application.edit-child-information', { childNumber: index + 1 })}
                  </ButtonLink>
                </CardFooter>
              </Card>
              ...
              <Card className="my-2">
                <CardHeader>
                  <CardTitle>{t('protected-application-full-family:childrens-application.child-dental-insurance-card-title')}</CardTitle>
                  <CardAction>{sections.childDentalInsurance.completed && <StatusTag status="complete" />}</CardAction>
                </CardHeader>
                <CardContent>
                  {child.dentalInsurance === undefined ? (
                    <p>{t('protected-application-full-family:childrens-application.child-dental-insurance-indicate-status')}</p>
                  ) : (
                    <DefinitionList layout="single-column">
                      <DefinitionListItem term={t('protected-application-full-family:childrens-application.dental-insurance-title')}>
                        <p>{child.dentalInsurance.hasDentalInsurance ? t('protected-application-full-family:childrens-application.dental-insurance-yes') : t('protected-application-full-family:childrens-application.dental-insurance-no')}</p>
                      </DefinitionListItem>
                    </DefinitionList>
                  )}
                </CardContent>
                <CardFooter className="border-t bg-zinc-100">
                  <ButtonLink
                    ...
                    size="lg"
                  >
                    {child.dentalInsurance === undefined ? t('protected-application-full-family:childrens-application.add-child-dental-insurance') : t('protected-application-full-family:childrens-application.edit-child-dental-insurance')}
                  </ButtonLink>
                </CardFooter>
              </Card>
              ...
              <Card className="my-2">
                <CardHeader>
                  <CardTitle>{t('protected-application-full-family:childrens-application.child-dental-benefits-card-title')}</CardTitle>
                  <CardAction>{sections.childDentalBenefits.completed && <StatusTag status="complete" />}</CardAction>
                </CardHeader>
                <CardContent>
                  {child.dentalBenefits === undefined ? (
                    <p>{t('protected-application-full-family:childrens-application.child-dental-benefits-indicate-status')}</p>
                  ) : (
                    <DefinitionList layout="single-column">
                      <DefinitionListItem term={t('protected-application-full-family:childrens-application.dental-benefits-title')}>
                        {child.dentalBenefits.federalBenefit.access || child.dentalBenefits.provTerrBenefit.access ? (
                          <div className="space-y-3">
                            <p>{t('protected-application-full-family:childrens-application.dental-benefits-yes')}</p>
                          ...
                          <p>{t('protected-application-full-family:childrens-application.dental-benefits-no')}</p>
                        )}
                      </DefinitionListItem>
                    </DefinitionList>
                  )}
                ...
                <CardFooter className="border-t bg-zinc-100">
                  <ButtonLink
                    ...
                    size="lg"
                  >
                    {child.dentalBenefits === undefined ? t('protected-application-full-family:childrens-application.add-child-dental-benefits') : t('protected-application-full-family:childrens-application.edit-child-dental-benefits')}
                  </ButtonLink>
                </CardFooter>
              </Card>
              <fetcher.Form method="post" noValidate>
                ...
                >
                  {t('protected-application-full-family:childrens-application.remove-child')}
                </Button>
              </fetcher.Form>
            </div>
          );
        ...
        <fetcher.Form method="post" noValidate>
          ...
          <Button variant="primary" id="add-child" name="_action" value={FORM_ACTION.add} disabled={isSubmitting} data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form-Family:Add child - Child(ren) application click">
            {t('protected-application-full-family:childrens-application.add-child')}
          </Button>
        </fetcher.Form>

        <div className="flex flex-row-reverse flex-wrap items-center justify-end gap-3">
          <NavigationButtonLink disabled={!allChildrenCompleted} variant="primary" direction="next" routeId="protected/application/$id/full-family/submit" params={params}>
            {t('protected-application-full-family:childrens-application.submit-btn')}
          </NavigationButtonLink>
          <NavigationButtonLink variant="secondary" direction="previous" routeId="protected/application/$id/full-family/dental-insurance" params={params}>
            {t('protected-application-full-family:childrens-application.back-btn')}
          </NavigationButtonLink>
        </div>
      </div>
    </>
