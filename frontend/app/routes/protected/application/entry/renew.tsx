...
import type { Route } from './+types/renew';
...
export const handle = {
  ...
  pageTitleI18nKey: 'protected-application:renewal-selection.page-title',
...
export default function ProtectedTypeOfApplication({ loaderData, params }: Route.ComponentProps) {
  ...
  return (
    <div className="max-w-prose space-y-8">
      ...
      <Card>
        <CardHeader>
          <CardTitle>{t('protected-application:renewal-selection.type-application-heading')}</CardTitle>
