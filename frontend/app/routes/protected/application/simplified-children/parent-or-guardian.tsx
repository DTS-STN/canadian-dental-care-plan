      ...
      <div className="max-w-prose space-y-8">
          ...
          <CardContent>
            {state.phoneNumber === undefined ? (
              ...
              <DefinitionList layout="single-column">
                <DefinitionListItem term={t('protected-application-simplified-child:parent-or-guardian.phone-number')}>
                  {state.phoneNumber.hasChanged === false ? <p>{t('protected-application-simplified-child:parent-or-guardian.no-change')}</p> : <p>{state.phoneNumber.value.primary}</p>}
                </DefinitionListItem>
              </DefinitionList>
            )}
          </CardContent>
          {state.phoneNumber ? (
            <CardFooter className="border-t bg-zinc-100">
              <ButtonLink id="edit-button" variant="link" className="p-0" routeId="protected/application/$id/phone-number" params={params} startIcon={sections.phoneNumber.completed ? faPenToSquare : faCirclePlus} size="lg">
                {sections.phoneNumber.completed ? t('protected-application-simplified-child:parent-or-guardian.edit-phone-number') : t('protected-application-simplified-child:parent-or-guardian.add-phone-number')}
              </ButtonLink>
            </CardFooter>
          ) : (
            ...
            {mailingAddressInfo.hasChanged === undefined && homeAddressInfo.hasChanged === undefined ? (
              ...
              <>
                {mailingAddressInfo.hasChanged === false && homeAddressInfo.hasChanged === false ? (
                  <p>{t('protected-application-simplified-child:parent-or-guardian.no-change')}</p>
                ) : (
                  <DefinitionList layout="single-column">
          ...
          {mailingAddressInfo.hasChanged !== undefined && homeAddressInfo.hasChanged !== undefined ? (
            <CardFooter className="border-t bg-zinc-100">
              <ButtonLink id="edit-button" variant="link" className="p-0" routeId="protected/application/$id/mailing-address" params={params} startIcon={sections.address.completed ? faPenToSquare : faCirclePlus} size="lg">
                {sections.address.completed ? t('protected-application-simplified-child:parent-or-guardian.edit-address') : t('protected-application-simplified-child:parent-or-guardian.add-address')}
              </ButtonLink>
            </CardFooter>
          ) : (
            <CardFooter className="divide-y border-t bg-zinc-100 px-0">
            ...
            {state.communicationPreferences === undefined ? (
              ...
              <>
                {state.communicationPreferences.hasChanged === false ? (
                  ...
                  <DefinitionList layout="single-column">
                    <DefinitionListItem term={t('protected-application-simplified-child:parent-or-guardian.preferred-language')}>{state.communicationPreferences.value.preferredLanguage}</DefinitionListItem>
                    <DefinitionListItem term={t('protected-application-simplified-child:parent-or-guardian.preferred-method')}>{state.communicationPreferences.value.preferredMethod}</DefinitionListItem>
                    <DefinitionListItem term={t('protected-application-simplified-child:parent-or-guardian.preferred-notification-method')}>{state.communicationPreferences.value.preferredNotificationMethod}</DefinitionListItem>
          ...
          {state.communicationPreferences ? (
            <CardFooter className="border-t bg-zinc-100">
              <ButtonLink id="edit-button" variant="link" className="p-0" routeId="protected/application/$id/communication-preferences" params={params} startIcon={sections.communicationPreferences.completed ? faPenToSquare : faCirclePlus} size="lg">
                {sections.communicationPreferences.completed ? t('protected-application-simplified-child:parent-or-guardian.edit-communication-preferences') : t('protected-application-simplified-child:parent-or-guardian.add-communication-preferences')}
              </ButtonLink>
            </CardFooter>
          ) : (
            <CardFooter className="divide-y border-t bg-zinc-100 px-0">
        ...
        <div className="flex flex-row-reverse flex-wrap items-center justify-end gap-3">
          <NavigationButtonLink disabled={!allSectionsCompleted} variant="primary" direction="next" routeId="protected/application/$id/simplified-children/childrens-application" params={params}>
            {t('protected-application-simplified-child:parent-or-guardian.childrens-application')}
          ...
          <NavigationButtonLink variant="secondary" direction="previous" routeId="protected/application/$id/type-of-application" params={params}>
            {t('protected-application-simplified-child:parent-or-guardian.type-of-application')}
          </NavigationButtonLink>
        </div>
      </div>
    </fetcher.Form>
