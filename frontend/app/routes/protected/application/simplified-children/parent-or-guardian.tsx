...
export const handle = {
  i18nNamespaces: getTypedI18nNamespaces('protected-application', 'protected-application-simplified-child', 'gcweb'),
  pageIdentifier: pageIds.protected.application.simplifiedChild.parentOrGuardian,
  pageTitleI18nKey: 'protected-application-simplified-child:parent-or-guardian.page-heading',
...
export async function loader({ context: { appContainer, session }, request, params }: Route.LoaderArgs) {
  ...
  const meta = { title: t('gcweb:meta.title.template', { title: t('protected-application-simplified-child:parent-or-guardian.page-title') }) };
  ...
  return (
    <fetcher.Form method="post" noValidate>
      ...
      <div className="max-w-prose space-y-8">
        ...
        <Card>
          <CardHeader>
            <CardTitle>{t('protected-application-simplified-child:parent-or-guardian.mailing-and-home-address')}</CardTitle>
        ...
        <Card>
          <CardHeader>
            <CardTitle>{t('protected-application-simplified-child:parent-or-guardian.communication-preferences')}</CardTitle>
        ...
        <div className="flex flex-row-reverse flex-wrap items-center justify-end gap-3">
          <NavigationButtonLink disabled={!allSectionsCompleted} variant="primary" direction="next" routeId="protected/application/$id/simplified-children/childrens-application" params={params}>
            {t('protected-application-simplified-child:parent-or-guardian.next-btn')}
          </NavigationButtonLink>
          <NavigationButtonLink variant="secondary" direction="previous" routeId="protected/application/$id/renew" params={params}>
            {t('protected-application-simplified-child:parent-or-guardian.prev-btn')}
          </NavigationButtonLink>
        </div>
      </div>
    </fetcher.Form>
...
function PhoneNumberCardContent(): JSX.Element {
  ...
  if (state.phoneNumber) {
    return (
      <CardContent>
        <DefinitionList layout="single-column">
          <DefinitionListItem term={t('protected-application-simplified-child:parent-or-guardian.phone-number')}>{state.phoneNumber.primary}</DefinitionListItem>
          {state.phoneNumber.alternate && <DefinitionListItem term={t('protected-application-simplified-child:parent-or-guardian.alt-phone-number')}>{state.phoneNumber.alternate}</DefinitionListItem>}
        </DefinitionList>
      </CardContent>
    );
  }
  ...
  if (clientApplication.phoneNumber) {
    return (
      <CardContent>
        <DefinitionList layout="single-column">
          <DefinitionListItem term={t('protected-application-simplified-child:parent-or-guardian.phone-number')}>{clientApplication.phoneNumber.primary}</DefinitionListItem>
          {clientApplication.phoneNumber.alternate && <DefinitionListItem term={t('protected-application-simplified-child:parent-or-guardian.alt-phone-number')}>{clientApplication.phoneNumber.alternate}</DefinitionListItem>}
        </DefinitionList>
      </CardContent>
    );
  }
  ...
  return (
    <CardContent>
      <p>{t('protected-application-simplified-child:parent-or-guardian.phone-number-help')}</p>
    </CardContent>
  );
}
    ...
    return (
      <CardFooter className="border-t bg-zinc-100">
        <ButtonLink id="edit-phone-button" variant="link" className="p-0" routeId="protected/application/$id/phone-number" params={params} startIcon={faPenToSquare} size="lg">
          {t('protected-application-simplified-child:parent-or-guardian.edit-phone-number')}
        </ButtonLink>
      </CardFooter>
    );
  }
      ...
      <CardFooter className="divide-y border-t bg-zinc-100 px-0">
        <div className="w-full px-6">
          <ButtonLink id="update-phone-button" variant="link" className="p-0 pb-5" routeId="protected/application/$id/phone-number" params={params} startIcon={faPenToSquare} size="lg">
            {t('protected-application-simplified-child:parent-or-guardian.update-phone-number')}
          </ButtonLink>
        </div>
        <div className="w-full px-6">
          <Button id="complete-phone-button" variant="link" name="_action" value={FORM_ACTION.PHONE_NUMBER_NOT_CHANGED} className="p-0 pt-5" startIcon={faCircleCheck} size="lg">
            {t('protected-application-simplified-child:parent-or-guardian.phone-number-unchanged')}
          </Button>
        </div>
      </CardFooter>
    );
  ...
  return (
    <CardFooter className="border-t bg-zinc-100">
      <ButtonLink id="add-phone-button" variant="link" className="p-0" routeId="protected/application/$id/phone-number" params={params} startIcon={faCirclePlus} size="lg">
        {t('protected-application-simplified-child:parent-or-guardian.add-phone-number')}
      </ButtonLink>
    </CardFooter>
  );
}
...
function MailingAndHomeAddressCardContent(): JSX.Element {
  ...
  if (state.mailingAddress && state.homeAddress) {
    return (
      <CardContent>
        <DefinitionList layout="single-column">
          <DefinitionListItem term={t('protected-application-simplified-child:parent-or-guardian.mailing-address')}>
            <Address
              address={{
          ...
          <DefinitionListItem term={t('protected-application-simplified-child:parent-or-guardian.home-address')}>
            <Address
              address={{
  ...
  return (
    <CardContent>
      <p>{t('protected-application-simplified-child:parent-or-guardian.address-help')}</p>
    </CardContent>
  );
}
    ...
    return (
      <CardFooter className="border-t bg-zinc-100">
        <ButtonLink id="edit-address-button" variant="link" className="p-0" routeId="protected/application/$id/mailing-address" params={params} startIcon={faPenToSquare} size="lg">
          {t('protected-application-simplified-child:parent-or-guardian.edit-address')}
        </ButtonLink>
      </CardFooter>
    );
  }
      ...
      <CardFooter className="divide-y border-t bg-zinc-100 px-0">
        <div className="w-full px-6">
          <ButtonLink id="update-address-button" variant="link" className="p-0 pb-5" routeId="protected/application/$id/mailing-address" params={params} startIcon={faPenToSquare} size="lg">
            {t('protected-application-simplified-child:parent-or-guardian.update-address')}
          </ButtonLink>
        </div>
        <div className="w-full px-6">
          <Button id="complete-address-button" variant="link" className="p-0 pt-5" name="_action" value={FORM_ACTION.ADDRESS_NOT_CHANGED} startIcon={faCircleCheck} size="lg">
            {t('protected-application-simplified-child:parent-or-guardian.address-unchanged')}
          </Button>
        </div>
      </CardFooter>
    );
  ...
  return (
    <CardFooter className="border-t bg-zinc-100">
      <ButtonLink id="add-address-button" variant="link" className="p-0" routeId="protected/application/$id/mailing-address" params={params} startIcon={faCirclePlus} size="lg">
        {t('protected-application-simplified-child:parent-or-guardian.add-address')}
      </ButtonLink>
    </CardFooter>
  );
}
...
function CommunicationPreferencesCardContent(): JSX.Element {
  ...
  if (state.communicationPreferences) {
    return (
      <CardContent>
        <DefinitionList layout="single-column">
          <DefinitionListItem term={t('protected-application-simplified-child:parent-or-guardian.preferred-language')}>{state.communicationPreferences.preferredLanguage}</DefinitionListItem>
          <DefinitionListItem term={t('protected-application-simplified-child:parent-or-guardian.preferred-method')}>{state.communicationPreferences.preferredMethod}</DefinitionListItem>
          <DefinitionListItem term={t('protected-application-simplified-child:parent-or-guardian.preferred-notification-method')}>{state.communicationPreferences.preferredNotificationMethod}</DefinitionListItem>
          {state.email && <DefinitionListItem term={t('protected-application-simplified-child:parent-or-guardian.email')}>{state.email}</DefinitionListItem>}
        </DefinitionList>
      </CardContent>
    );
  }
  ...
  if (clientApplication.communicationPreferences) {
    return (
      <CardContent>
        <DefinitionList layout="single-column">
          <DefinitionListItem term={t('protected-application-simplified-child:parent-or-guardian.preferred-language')}>{clientApplication.communicationPreferences.preferredLanguage}</DefinitionListItem>
          <DefinitionListItem term={t('protected-application-simplified-child:parent-or-guardian.preferred-method')}>{clientApplication.communicationPreferences.preferredMethod}</DefinitionListItem>
          <DefinitionListItem term={t('protected-application-simplified-child:parent-or-guardian.preferred-notification-method')}>{clientApplication.communicationPreferences.preferredNotificationMethod}</DefinitionListItem>
          {clientApplication.email && <DefinitionListItem term={t('protected-application-simplified-child:parent-or-guardian.email')}>{clientApplication.email}</DefinitionListItem>}
        </DefinitionList>
      </CardContent>
    );
  }
  ...
  return (
    <CardContent>
      <p>{t('protected-application-simplified-child:parent-or-guardian.communication-preferences-help')}</p>
    </CardContent>
  );
}
    ...
    return (
      <CardFooter className="border-t bg-zinc-100">
        <ButtonLink id="edit-comms-button" variant="link" className="p-0" routeId="protected/application/$id/communication-preferences" params={params} startIcon={faPenToSquare} size="lg">
          {t('protected-application-simplified-child:parent-or-guardian.edit-communication-preferences')}
        </ButtonLink>
      </CardFooter>
    );
  }
      ...
      <CardFooter className="divide-y border-t bg-zinc-100 px-0">
        <div className="w-full px-6">
          <ButtonLink id="update-comms-button" variant="link" className="p-0 pb-5" routeId="protected/application/$id/communication-preferences" params={params} startIcon={faPenToSquare} size="lg">
            {t('protected-application-simplified-child:parent-or-guardian.update-communication-preferences')}
          </ButtonLink>
        </div>
        <div className="w-full px-6">
          <Button id="complete-comms-button" variant="link" name="_action" value={FORM_ACTION.COMMUNICATION_PREFERENCES_NOT_CHANGED} className="p-0 pt-5" startIcon={faCircleCheck} size="lg">
            {t('protected-application-simplified-child:parent-or-guardian.communication-preferences-unchanged')}
          </Button>
        </div>
      </CardFooter>
    );
  ...
  return (
    <CardFooter className="border-t bg-zinc-100">
      <ButtonLink id="add-comms-button" variant="link" className="p-0" routeId="protected/application/$id/communication-preferences" params={params} startIcon={faCirclePlus} size="lg">
        {t('protected-application-simplified-child:parent-or-guardian.add-communication-preferences')}
      </ButtonLink>
    </CardFooter>
  );
}
