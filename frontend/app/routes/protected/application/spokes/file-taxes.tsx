...
export const handle = { i18nNamespaces: getTypedI18nNamespaces('application', 'gcweb'), pageIdentifier: pageIds.protected.application.spokes.fileYourTaxes, pageTitleI18nKey: 'application:file-your-taxes.page-title' } as const satisfies RouteHandleData;
