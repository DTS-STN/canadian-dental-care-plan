...
export const handle = {
  ...
  pageIdentifier: pageIds.protected.application.simplifiedAdult.contactInformation,
  pageTitleI18nKey: 'protected-application-simplified-adult:contact-information.page-heading',
  ...
  return (
    <fetcher.Form method="post" noValidate>
      ...
      <div className="max-w-prose space-y-8">
        ...
        <Card>
          <CardHeader>
            <CardTitle>{t('protected-application-simplified-adult:contact-information.phone-number')}</CardTitle>
        ...
        <Card>
          <CardHeader>
            <CardTitle>{t('protected-application-simplified-adult:contact-information.mailing-and-home-address')}</CardTitle>
        ...
        <Card>
          <CardHeader>
            <CardTitle>{t('protected-application-simplified-adult:contact-information.communication-preferences')}</CardTitle>
...
function PhoneNumberCardContent(): JSX.Element {
    ...
    return (
      <CardContent>
        <DefinitionList layout="single-column">
          <DefinitionListItem term={t('protected-application-simplified-adult:contact-information.phone-number')}>{state.phoneNumber.primary}</DefinitionListItem>
          {state.phoneNumber.alternate && <DefinitionListItem term={t('protected-application-simplified-adult:contact-information.alt-phone-number')}>{state.phoneNumber.alternate}</DefinitionListItem>}
        </DefinitionList>
      </CardContent>
    );
  }
  ...
  if (clientApplication.phoneNumber) {
    return (
      <CardContent>
        <DefinitionList layout="single-column">
          <DefinitionListItem term={t('protected-application-simplified-adult:contact-information.phone-number')}>{clientApplication.phoneNumber.primary}</DefinitionListItem>
          {clientApplication.phoneNumber.alternate && <DefinitionListItem term={t('protected-application-simplified-adult:contact-information.alt-phone-number')}>{clientApplication.phoneNumber.alternate}</DefinitionListItem>}
        </DefinitionList>
      </CardContent>
    );
  }
    ...
    return (
      <CardFooter className="border-t bg-zinc-100">
        <ButtonLink id="edit-phone-button" variant="link" className="p-0" routeId="protected/application/$id/phone-number" params={params} startIcon={faPenToSquare} size="lg">
          {t('protected-application-simplified-adult:contact-information.edit-phone-number')}
        </ButtonLink>
      </CardFooter>
    );
  }
  ...
  return (
    <CardFooter className="border-t bg-zinc-100">
      <ButtonLink id="add-phone-button" variant="link" className="p-0" routeId="protected/application/$id/phone-number" params={params} startIcon={faCirclePlus} size="lg">
        {t('protected-application-simplified-adult:contact-information.add-phone-number')}
      </ButtonLink>
    </CardFooter>
  );
}
    ...
    return (
      <CardFooter className="border-t bg-zinc-100">
        <ButtonLink id="edit-address-button" variant="link" className="p-0" routeId="protected/application/$id/mailing-address" params={params} startIcon={faPenToSquare} size="lg">
          {t('protected-application-simplified-adult:contact-information.edit-address')}
        </ButtonLink>
      </CardFooter>
    );
  }
    ...
    return (
      <CardFooter className="border-t bg-zinc-100">
        <ButtonLink id="edit-comms-button" variant="link" className="p-0" routeId="protected/application/$id/communication-preferences" params={params} startIcon={faPenToSquare} size="lg">
          {t('protected-application-simplified-adult:contact-information.edit-communication-preferences')}
        </ButtonLink>
      </CardFooter>
    );
  }
