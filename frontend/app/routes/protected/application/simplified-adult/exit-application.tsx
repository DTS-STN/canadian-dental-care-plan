...
export const handle = {
  ...
  pageIdentifier: pageIds.protected.application.simplifiedAdult.exitApplication,
  pageTitleI18nKey: 'protected-application-simplified-adult:exit-application.page-title',
...
export async function loader({ context: { appContainer, session }, params, request }: Route.LoaderArgs) {
  ...
  const meta = { title: t('gcweb:meta.title.template', { title: t('protected-application-simplified-adult:exit-application.page-title') }) };
  return { meta };
}
  ...
  return (
    <div className="max-w-prose">
      <div className="mb-8 space-y-4">
        <p>{t('protected-application-simplified-adult:exit-application.are-you-sure')}</p>
        <p>{t('protected-application-simplified-adult:exit-application.click-back')}</p>
      </div>
      <fetcher.Form method="post" noValidate className="flex flex-wrap items-center gap-3">
        ...
        <ButtonLink
          id="back-button"
          variant="secondary"
          routeId="protected/application/$id/simplified-adult/submit"
          params={params}
