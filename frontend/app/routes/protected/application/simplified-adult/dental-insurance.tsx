...
export const handle = {
  ...
  pageIdentifier: pageIds.protected.application.simplifiedAdult.dentalInsurance,
  pageTitleI18nKey: 'protected-application-simplified-adult:dental-insurance.page-heading',
  ...
  return (
    <fetcher.Form method="post" noValidate>
      ...
      <div className="max-w-prose space-y-8">
        ...
        <Card>
          <CardHeader>
            <CardTitle>{t('protected-application-simplified-adult:dental-insurance.access-to-dental-insurance')}</CardTitle>
            <CardAction>{sections.dentalInsurance.completed && <StatusTag status="complete" />}</CardAction>
          </CardHeader>
          <CardContent>
            {state.dentalInsurance === undefined ? (
              <p>{t('protected-application-simplified-adult:dental-insurance.dental-insurance-indicate-status')}</p>
            ) : (
              <DefinitionList layout="single-column">
                <DefinitionListItem term={t('protected-application-simplified-adult:dental-insurance.access-to-dental-insurance-or-coverage')}>
                  <p>{state.dentalInsurance ? t('protected-application-simplified-adult:dental-insurance.dental-insurance-yes') : t('protected-application-simplified-adult:dental-insurance.dental-insurance-no')}</p>
                </DefinitionListItem>
              </DefinitionList>
            )}
          </CardContent>
          <CardFooter className="border-t bg-zinc-100">
            <ButtonLink id="edit-button-dental-insurance" variant="link" className="p-0" routeId="protected/application/$id/dental-insurance" params={params} startIcon={sections.dentalInsurance.completed ? faPenToSquare : faCirclePlus} size="lg">
              {state.dentalInsurance === undefined ? t('protected-application-simplified-adult:dental-insurance.add-answer') : t('protected-application-simplified-adult:dental-insurance.edit-access-to-dental-insurance')}
            </ButtonLink>
          </CardFooter>
        </Card>
        ...
        <Card>
          <CardHeader>
            <CardTitle>{t('protected-application-simplified-adult:dental-insurance.other-benefits')}</CardTitle>
            ...
            <CardFooter className="divide-y border-t bg-zinc-100 px-0">
              <div className="w-full px-6">
                <ButtonLink id="edit-button-update-access" variant="link" className="p-0 pb-5" routeId="protected/application/$id/federal-provincial-territorial-benefits" params={params} startIcon={faPenToSquare} size="lg">
                  {t('protected-application-simplified-adult:dental-insurance.update-my-access')}
                </ButtonLink>
              </div>
              <div className="w-full px-6">
        ...
        <div className="flex flex-row-reverse flex-wrap items-center justify-end gap-3">
          <NavigationButtonLink disabled={!allSectionsCompleted} variant="primary" direction="next" routeId="protected/application/$id/simplified-adult/submit" params={params}>
            {t('protected-application-simplified-adult:dental-insurance.submit')}
          </NavigationButtonLink>
          <NavigationButtonLink variant="secondary" direction="previous" routeId="protected/application/$id/simplified-adult/contact-information" params={params}>
            {t('protected-application-simplified-adult:dental-insurance.contact-information')}
          </NavigationButtonLink>
        </div>
      </div>
    </fetcher.Form>
