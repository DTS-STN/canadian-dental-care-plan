...
export const handle = {
  ...
  pageTitleI18nKey: 'protected-application-renewal-child:childrens-application.page-title',
...
export async function loader({ context: { appContainer, session }, request, params }: Route.LoaderArgs) {
  ...
  const meta = { title: t('gcweb:meta.title.template', { title: t('protected-application-renewal-child:childrens-application.page-title') }) };
...
function ChildSinCardContent({ child }: { child: Route.ComponentProps['loaderData']['state']['children'][0] }): JSX.Element {
    ...
    return (
      <CardContent>
        <DefinitionList layout="single-column">
          <DefinitionListItem term={t('protected-application-renewal-child:childrens-application.sin-title')}>{formatSin(child.information.socialInsuranceNumber)}</DefinitionListItem>
        </DefinitionList>
      </CardContent>
    );
  }
  ...
  return (
    <CardContent>
      <p>{t('protected-application-renewal-child:childrens-application.sin-help')}</p>
    </CardContent>
  );
}
...
function ChildParentGuardianCardContent({ child }: { child: Route.ComponentProps['loaderData']['state']['children'][0] }): JSX.Element {
      ...
      <CardContent>
        <DefinitionList layout="single-column">
          <DefinitionListItem term={t('protected-application-renewal-child:childrens-application.parent-guardian-title')}>
            {child.information.isParent ? t('protected-application-renewal-child:childrens-application.yes') : t('protected-application-renewal-child:childrens-application.no')}
          </DefinitionListItem>
        </DefinitionList>
      </CardContent>
    );
  ...
  return (
    <CardContent>
      <p>{t('protected-application-renewal-child:childrens-application.parent-guardian-help')}</p>
    </CardContent>
  );
}
...
function ChildDentalInsuranceCardContent({ child }: { child: Route.ComponentProps['loaderData']['state']['children'][0] }): JSX.Element {
  ...
  if (child.dentalInsurance !== undefined) {
    return (
      <CardContent>
        <DefinitionList layout="single-column">
          <DefinitionListItem term={t('protected-application-renewal-child:childrens-application.dental-insurance-title')}>
            {child.dentalInsurance.hasDentalInsurance ? t('protected-application-renewal-child:childrens-application.dental-insurance-yes') : t('protected-application-renewal-child:childrens-application.dental-insurance-no')}
          </DefinitionListItem>
        </DefinitionList>
      </CardContent>
    );
  ...
  return (
    <CardContent>
      <p>{t('protected-application-renewal-child:childrens-application.child-dental-insurance-indicate-status')}</p>
    </CardContent>
  );
}
...
function ChildDentalBenefitsCardContent({ child }: { child: Route.ComponentProps['loaderData']['state']['children'][0] }): JSX.Element {
  ...
  const renderBenefits = (benefits: ClientDentalBenefits) => {
    ...
    if (hasBenefits) {
      return (
        <div className="space-y-3">
          <p>{t('protected-application-renewal-child:childrens-application.dental-benefits-yes')}</p>
    ...
    return <p>{t('protected-application-renewal-child:childrens-application.dental-benefits-no')}</p>;
  };
  ...
  if (child.dentalBenefits?.hasChanged) {
    return (
      <CardContent>
        <DefinitionList layout="single-column">
          <DefinitionListItem term={t('protected-application-renewal-child:childrens-application.dental-benefits-title')}>{renderBenefits(child.dentalBenefits)}</DefinitionListItem>
        </DefinitionList>
      </CardContent>
    );
  }
  ...
  return (
    <CardContent>
      <DefinitionList layout="single-column">
        <DefinitionListItem term={t('protected-application-renewal-child:childrens-application.dental-benefits-title')}>{renderBenefits(child.clientApplication.clientDentalBenefits)}</DefinitionListItem>
      </DefinitionList>
    </CardContent>
  );
}
