      ...
      <CardContent>
        <DefinitionList layout="single-column">
          <DefinitionListItem term={t('protected-application-renewal-child:childrens-application.dental-insurance-title')}>
            <p>{child.dentalInsurance.hasDentalInsurance ? t('protected-application-renewal-child:childrens-application.dental-insurance-yes') : t('protected-application-renewal-child:childrens-application.dental-insurance-no')}</p>
          </DefinitionListItem>
        </DefinitionList>
      </CardContent>
    );
...
function ChildDentalBenefitsCardContent({ child }: { child: Route.ComponentProps['loaderData']['state']['children'][0] }): JSX.Element {
  ...
  return (
    <CardContent>
      <p>{t('protected-application-renewal-child:childrens-application.child-dental-benefits-indicate-status')}</p>
    </CardContent>
  );
}
