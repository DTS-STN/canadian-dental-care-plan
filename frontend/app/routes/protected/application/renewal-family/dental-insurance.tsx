  ...
  return (
    <fetcher.Form method="post" noValidate>
      ...
      <div className="max-w-prose space-y-8">
        ...
        <Card>
          <CardHeader>
            <CardTitle>{t('protected-application-renewal-family:dental-insurance.access-to-dental-insurance')}</CardTitle>
          ...
          <CardFooter className="border-t bg-zinc-100">
            <ButtonLink id="edit-button-dental-insurance" variant="link" className="p-0" routeId="protected/application/$id/dental-insurance" params={params} startIcon={sections.dentalInsurance.completed ? faPenToSquare : faCirclePlus} size="lg">
              {state.dentalInsurance === undefined ? t('protected-application-renewal-family:dental-insurance.add-answer') : t('protected-application-renewal-family:dental-insurance.edit-access-to-dental-insurance')}
            </ButtonLink>
          </CardFooter>
        </Card>
        ...
        <Card>
          <CardHeader>
            <CardTitle>{t('protected-application-renewal-family:dental-insurance.other-benefits')}</CardTitle>
              ...
              <DefinitionList layout="single-column">
                <DefinitionListItem term={t('protected-application-renewal-family:dental-insurance.access-to-government-benefits')}>
                  {state.dentalBenefits.hasChanged ? (
                    ...
                    <p>{t('protected-application-renewal-family:dental-insurance.no-change')}</p>
                  )}
                </DefinitionListItem>
              </DefinitionList>
            ) : (
