    ...
    <fetcher.Form method="post" noValidate>
      ...
      <div className="max-w-prose space-y-8">
          ...
          <CardContent>
            {state.phoneNumber === undefined ? (
              ...
              <DefinitionList layout="single-column">
                <DefinitionListItem term={t('protected-application-renewal-family:contact-information.phone-number')}>
                  {state.phoneNumber.hasChanged === false ? <p>{t('protected-application-renewal-family:contact-information.no-change')}</p> : <p>{state.phoneNumber.value.primary}</p>}
                </DefinitionListItem>
              </DefinitionList>
            )}
          </CardContent>
          {state.phoneNumber ? (
            <CardFooter className="border-t bg-zinc-100">
              <ButtonLink id="edit-phone-button" variant="link" className="p-0" routeId="protected/application/$id/phone-number" params={params} startIcon={sections.phoneNumber.completed ? faPenToSquare : faCirclePlus} size="lg">
                {sections.phoneNumber.completed ? t('protected-application-renewal-family:contact-information.edit-phone-number') : t('protected-application-renewal-family:contact-information.add-phone-number')}
              </ButtonLink>
            </CardFooter>
          ) : (
            ...
            {mailingAddressInfo.hasChanged === undefined && homeAddressInfo.hasChanged === undefined ? (
              ...
              <>
                {mailingAddressInfo.hasChanged === false && homeAddressInfo.hasChanged === false ? (
                  <p>{t('protected-application-renewal-family:contact-information.no-change')}</p>
                ) : (
                  <DefinitionList layout="single-column">
          ...
          {mailingAddressInfo.hasChanged !== undefined && homeAddressInfo.hasChanged !== undefined ? (
            <CardFooter className="border-t bg-zinc-100">
              <ButtonLink id="edit-address-button" variant="link" className="p-0" routeId="protected/application/$id/mailing-address" params={params} startIcon={sections.address.completed ? faPenToSquare : faCirclePlus} size="lg">
                {sections.address.completed ? t('protected-application-renewal-family:contact-information.edit-address') : t('protected-application-renewal-family:contact-information.add-address')}
              </ButtonLink>
            </CardFooter>
          ) : (
            <CardFooter className="divide-y border-t bg-zinc-100 px-0">
            ...
            {state.communicationPreferences === undefined ? (
              ...
              <>
                {state.communicationPreferences.hasChanged === false ? (
                  ...
                  <DefinitionList layout="single-column">
                    <DefinitionListItem term={t('protected-application-renewal-family:contact-information.preferred-language')}>{preferredLanguage?.name}</DefinitionListItem>
                    <DefinitionListItem term={t('protected-application-renewal-family:contact-information.preferred-method')}>{preferredMethod?.name}</DefinitionListItem>
                    <DefinitionListItem term={t('protected-application-renewal-family:contact-information.preferred-notification-method')}>{preferredNotificationMethod?.name}</DefinitionListItem>
          ...
          {state.communicationPreferences ? (
            <CardFooter className="border-t bg-zinc-100">
              <ButtonLink id="edit-comms-button" variant="link" className="p-0" routeId="protected/application/$id/communication-preferences" params={params} startIcon={sections.communicationPreferences.completed ? faPenToSquare : faCirclePlus} size="lg">
                {sections.communicationPreferences.completed ? t('protected-application-renewal-family:contact-information.edit-communication-preferences') : t('protected-application-renewal-family:contact-information.add-communication-preferences')}
              </ButtonLink>
            </CardFooter>
          ) : (
            <CardFooter className="divide-y border-t bg-zinc-100 px-0">
        ...
        <div className="flex flex-row-reverse flex-wrap items-center justify-end gap-3">
          <NavigationButtonLink disabled={!allSectionsCompleted} variant="primary" direction="next" routeId="protected/application/$id/renewal-family/dental-insurance" params={params}>
          ...
          {shouldSkipMaritalStatusStep ? (
            ...
            <NavigationButtonLink variant="secondary" direction="previous" routeId="protected/application/$id/renewal-family/marital-status" params={params}>
