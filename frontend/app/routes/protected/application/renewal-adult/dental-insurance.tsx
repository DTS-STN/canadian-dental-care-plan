      ...
      <CardContent>
        <DefinitionList layout="single-column">
          <DefinitionListItem term={t('protected-application-renewal-adult:dental-insurance.access-to-dental-insurance-or-coverage')}>
            {state.dentalInsurance ? t('protected-application-renewal-adult:dental-insurance.dental-insurance-yes') : t('protected-application-renewal-adult:dental-insurance.dental-insurance-no')}
          </DefinitionListItem>
        </DefinitionList>
      </CardContent>
    );
  ...
  return (
    <CardFooter className="border-t bg-zinc-100">
      <ButtonLink
        ...
        aria-label={`${t('protected-application-renewal-adult:dental-insurance.add-answer')} - ${t('protected-application-renewal-adult:dental-insurance.access-to-dental-insurance')}`}
      >
    ...
    return (
      <CardFooter className="divide-y border-t bg-zinc-100 px-0">
        ...
        <div className="w-full px-6">
          ...
          >
            <span className="text-left">{t('protected-application-renewal-adult:dental-insurance.access-not-changed')}</span>
          </Button>
        </div>
      </CardFooter>
    );
  ...
  return (
    <CardFooter className="border-t bg-zinc-100">
      <ButtonLink
        ...
        aria-label={`${t('protected-application-renewal-adult:dental-insurance.add-answer')} - ${t('protected-application-renewal-adult:dental-insurance.other-benefits')}`}
      >
        {t('protected-application-renewal-adult:dental-insurance.add-answer')}
      </ButtonLink>
    </CardFooter>
