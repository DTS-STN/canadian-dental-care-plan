  ...
  return (
    <fetcher.Form method="post" noValidate>
      ...
      <div className="max-w-prose space-y-8">
        ...
        <Card>
          <CardHeader>
            <CardTitle>{t('protected-application-renewal-adult:contact-information.phone-number')}</CardTitle>
        ...
        <Card>
          <CardHeader>
            <CardTitle>{t('protected-application-renewal-adult:contact-information.mailing-and-home-address')}</CardTitle>
        ...
        <Card>
          <CardHeader>
            <CardTitle>{t('protected-application-renewal-adult:contact-information.communication-preferences')}</CardTitle>
