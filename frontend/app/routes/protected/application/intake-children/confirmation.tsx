...
export const handle = {
  ...
  pageTitleI18nKey: 'protected-application-intake-child:confirm.page-title',
...
export async function loader({ context: { appContainer, session }, params, request }: Route.LoaderArgs) {
  ...
  const meta = { title: t('gcweb:meta.title.template', { title: t('protected-application-intake-child:confirm.page-title') }) };
    ...
    <div className="max-w-prose space-y-10">
          ...
          {children.map((child) => {
            ...
            return (
              <section key={child.id} className="space-y-10">
                ...
                <div>
                  <h3 className="font-lato mb-6 text-2xl font-bold">{t('protected-application-intake-child:confirm.page-sub-title', { child: child.firstName })}</h3>
                  <DefinitionList border>
                    <DefinitionListItem term={t('confirm.member-id')}>{child.memberId}</DefinitionListItem>
                    <DefinitionListItem term={t('protected-application-intake-child:confirm.full-name')}>{`${child.firstName} ${child.lastName}`}</DefinitionListItem>
                    ...
                    <DefinitionListItem term={t('protected-application-intake-child:confirm.is-parent')}>{child.isParent ? t('protected-application-intake-child:confirm.yes') : t('protected-application-intake-child:confirm.no')}</DefinitionListItem>
                  </DefinitionList>
                </div>
                <div>
                  <h3 className="font-lato mb-6 text-2xl font-bold">{t('protected-application-intake-child:confirm.dental-title', { child: child.firstName })}</h3>
                  <DefinitionList border>
                    <DefinitionListItem term={t('protected-application-intake-child:confirm.dental-private')}>
                    ...
                    <DefinitionListItem term={t('protected-application-intake-child:confirm.dental-public')}>
                      {child.dentalInsurance.federalBenefit.access || child.dentalInsurance.provTerrBenefit.access ? (
                        <div className="space-y-3">
                          ...
                          <p>{t('protected-application-intake-child:confirm.dental-benefit-has-access')}</p>
                          <ul className="list-disc space-y-1 pl-7">
      ...
      <Dialog>
        <DialogTrigger className="print:hidden" data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form-Protected-Intake_Child:Exit - Application successfully submitted click" asChild>
          <Button variant="secondary">{t('protected-application-intake-child:confirm.close-application')}</Button>
        </DialogTrigger>
