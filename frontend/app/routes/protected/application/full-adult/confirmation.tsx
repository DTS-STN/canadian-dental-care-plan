...
export const handle = {
  ...
  pageIdentifier: pageIds.protected.application.fullAdult.confirmation,
  pageTitleI18nKey: 'protected-application-full-adult:confirm.page-title',
...
export default function ApplyFlowConfirm({ loaderData, params }: Route.ComponentProps) {
  ...
  const cdcpLink = <InlineLink to={t('protected-application-full-adult:confirm.status-checker-link')} className="external-link" newTabIndicator target="_blank" />;
    ...
    <div className="max-w-prose space-y-10">
            ...
            <DefinitionListItem term={t('confirm.dental-public')}>
              {dentalInsurance.selectedFederalBenefits || dentalInsurance.selectedProvincialBenefits ? (
                <div className="space-y-3">
                  <p>{t('protected-application-full-adult:confirm.yes')}</p>
                  <p>{t('protected-application-full-adult:confirm.dental-benefit-has-access')}</p>
                  <ul className="list-disc space-y-1 pl-7">
      ...
      <Dialog>
        <DialogTrigger asChild>
          ...
          >
            {t('protected-application-full-adult:confirm.close-application')}
          </button>
        </DialogTrigger>
        <DialogContent aria-describedby={undefined} className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>{t('protected-application-full-adult:confirm.modal.header')}</DialogTitle>
          </DialogHeader>
          <p>{t('protected-application-full-adult:confirm.modal.info')}</p>
          <p>{t('protected-application-full-adult:confirm.modal.are-you-sure')}</p>
          <DialogFooter>
            <DialogClose asChild>
              <Button id="confirm-modal-back" variant="secondary" size="sm" data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form-Adult:Back exit modal - Application successfully submitted click">
                {t('protected-application-full-adult:confirm.modal.back-btn')}
              </Button>
            </DialogClose>
            <fetcher.Form method="post" noValidate>
              ...
              >
                {t('protected-application-full-adult:confirm.modal.close-btn')}
              </Button>
            </fetcher.Form>
          </DialogFooter>
        </DialogContent>
