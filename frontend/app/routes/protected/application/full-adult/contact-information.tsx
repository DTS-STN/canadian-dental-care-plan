      ...
      <div className="max-w-prose space-y-8">
        ...
        <Card>
          ...
          <CardContent>
            {state.email ? (
              <DefinitionList layout="single-column">
                <DefinitionListItem term={t('protected-application-full-adult:contact-information.email')}>{state.email}</DefinitionListItem>
              </DefinitionList>
            ) : (
              <p>{t('protected-application-full-adult:contact-information.email-help')}</p>
            )}
          </CardContent>
          <CardFooter className="border-t bg-zinc-100">
