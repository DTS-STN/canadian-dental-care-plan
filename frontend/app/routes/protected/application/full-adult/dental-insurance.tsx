...
export default function ProtectedNewAdultDentalInsurance({ loaderData, params }: Route.ComponentProps) {
            ...
            {state.dentalInsurance?.dentalInsuranceEligibilityConfirmation === true ? (
              <DefinitionList layout="single-column">
                <DefinitionListItem term={t('protected-application-full-adult:dental-insurance.access-to-dental-insurance-or-coverage')}>
                  {state.dentalInsurance.hasDentalInsurance ? t('protected-application-full-adult:dental-insurance.dental-insurance-yes') : t('protected-application-full-adult:dental-insurance.dental-insurance-no')}
                </DefinitionListItem>
              </DefinitionList>
            ) : (
        ...
        <Card>
          ...
          <CardContent>
            {state.dentalBenefits ? (
              ...
              <p>{t('protected-application-full-adult:dental-insurance.dental-benefits-indicate-status')}</p>
            )}
          </CardContent>
          <CardFooter className="border-t bg-zinc-100">
            <ButtonLink id="edit-button" variant="link" className="p-0" routeId="protected/application/$id/federal-provincial-territorial-benefits" params={params} startIcon={sections.dentalBenefits.completed ? faPenToSquare : faCirclePlus} size="lg">
              {state.dentalBenefits === undefined ? t('protected-application-full-adult:dental-insurance.add-answer') : t('protected-application-full-adult:dental-insurance.edit-access-to-government-benefits')}
            </ButtonLink>
          </CardFooter>
        </Card>
