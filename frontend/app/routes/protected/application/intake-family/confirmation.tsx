...
export async function loader({ context: { appContainer, session }, params, request }: Route.LoaderArgs) {
  ...
  const children = await Promise.all(
    state.children.map(async (childState) => {
      ...
      const childDentalBenefits = await resolveProtectedStateChildDentalBenefitsValue({ dentalBenefits: childState.dentalBenefits }, undefined, locale, federalGovernmentInsurancePlanService, provincialGovernmentInsurancePlanService);
