...
export async function loader({ context: { appContainer, session }, params, request }: Route.LoaderArgs) {
  ...
  const meta = {
    title: t('gcweb:meta.title.msca-template', { title: t('protected-renew:children.dental-insurance.title', { childName }) }),
    dcTermsTitle: t('gcweb:meta.title.msca-template', { title: t('protected-renew:children.dental-insurance.title', { childName: childNumber }) }),
  };
...
export async function action({ context: { appContainer, session }, params, request }: Route.ActionArgs) {
  ...
  const dentalInsuranceSchema = z.object({
    dentalInsurance: z.boolean({ error: t('protected-renew:children.dental-insurance.error-message.dental-insurance-required') }),
  });
