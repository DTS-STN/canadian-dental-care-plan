...
export async function loader({ context: { appContainer, session }, params, request }: Route.LoaderArgs) {
  ...
  const meta = { title: t('gcweb:meta.title.msca-template', { title: t('protected-renew:review-adult-information.page-title') }) };
    ...
    <div className="max-w-prose">
        ...
        <section className="space-y-6">
          ...
          <dl className="divide-y border-y">
            ...
            <DescriptionListItem term={t('protected-renew:review-adult-information.marital-title')}>
              ...
              <div className="mt-4">
                <InlineLink id="change-marital-status" routeId="protected/renew/$id/confirm-marital-status" params={params}>
      ...
      <fetcher.Form method="post" className="mt-8 flex flex-row-reverse flex-wrap items-center justify-end gap-3">
        ...
        <Button
          ...
          data-gc-analytics-customclick="ESDC-EDSC:CDCP Renew Application Form-Protected:Back - Review your information click"
        >
