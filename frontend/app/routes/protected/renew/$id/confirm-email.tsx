...
export async function loader({ context: { appContainer, session }, params, request }: Route.LoaderArgs) {
  ...
  instrumentationService.countHttpStatus('protected.renew.confirm-email', 200);
...
export async function action({ context: { appContainer, session }, params, request }: Route.ActionArgs) {
  ...
  if (!parsedDataResult.success) {
    instrumentationService.countHttpStatus('protected.renew.confirm-email', 400);
  ...
  instrumentationService.countHttpStatus('protected.renew.confirm-email', 302);
