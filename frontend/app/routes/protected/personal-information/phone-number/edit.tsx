...
export const handle = {
  breadcrumbs: [
    // prettier-ignore
    { labelI18nKey: 'personal-information:phone-number.edit.breadcrumbs.personal-information', routeId: 'protected/personal-information/index' },
    ...
    <>
      ...
      <fetcher.Form className="max-w-prose" method="post" noValidate>
        ...
        <div className="flex flex-wrap items-center gap-6 sm:my-4">
          <ButtonLink id="cancel" routeId="protected/personal-information/index" params={params} disabled={isSubmitting} data-gc-analytics-customclick="ESDC-EDSC:CDCP Personal Information:Cancel - Phone number click">
