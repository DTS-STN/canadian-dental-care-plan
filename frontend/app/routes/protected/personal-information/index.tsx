    ...
    <div className="max-w-prose font-lato">
      ...
      <dl className="mt-6 divide-y">
        ...
        <DescriptionListItemTwoColumn term={t('personal-information:index.addresses')}>
          <dl>
            ...
            <dd className="mt-4">
              ...
              {useFeature('edit-personal-info') && (
                <p className="mt-4">
                  <InlineLink id="change-home-address-button" routeId="protected/personal-information/home-address/edit" params={params} data-gc-analytics-customclick="ESDC-EDSC:CDCP:Change home address - Personal Information click">
          ...
          <dl>
            ...
            <dd className="mt-4">
              ...
              {useFeature('edit-personal-info') && (
                <p className="mt-4">
                  <InlineLink id="change-mailing-address-button" routeId="protected/personal-information/mailing-address/edit" params={params} data-gc-analytics-customclick="ESDC-EDSC:CDCP:Change mailing address - Personal Information click">
        ...
        <DescriptionListItemTwoColumn term={t('personal-information:index.phone-number')}>
          <dl>
            ...
            <dd className="mt-4">
              ...
              {useFeature('edit-personal-info') && (
                <p className="mt-4">
                  <InlineLink id="change-phone-number-button" routeId="protected/personal-information/phone-number/edit" params={params} data-gc-analytics-customclick="ESDC-EDSC:CDCP:Change phone number - Personal Information click">
        ...
        <DescriptionListItem term={t('personal-information:index.email-address')}>
          ...
          {useFeature('edit-personal-info') && (
            <p>
              <InlineLink id="change-email-address-button" routeId="protected/personal-information/email-address/edit" params={params} data-gc-analytics-customclick="ESDC-EDSC:CDCP:Change email address - Personal Information click">
        ...
        <DescriptionListItem term={t('personal-information:index.preferred-language')}>
          ...
          {useFeature('edit-personal-info') && (
            <p>
              <InlineLink id="change-preferred-language-button" routeId="protected/personal-information/preferred-language/edit" params={params} data-gc-analytics-customclick="ESDC-EDSC:CDCP:Change preferred language - Personal Information click">
