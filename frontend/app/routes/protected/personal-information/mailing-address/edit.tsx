...
export const handle = {
  breadcrumbs: [
    // prettier-ignore
    { labelI18nKey: 'personal-information:mailing-address.edit.breadcrumbs.personal-information', routeId: 'protected/personal-information/index' },
    ...
    <>
      ...
      <fetcher.Form className="max-w-prose" method="post" noValidate>
        ...
        <div className="flex flex-wrap items-center gap-3">
          <ButtonLink id="back-button" routeId="protected/personal-information/index" params={params} disabled={isSubmitting} data-gc-analytics-customclick="ESDC-EDSC:CDCP Personal Information:Back - Mailing address click">
