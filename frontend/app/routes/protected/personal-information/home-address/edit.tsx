...
export const handle = {
  breadcrumbs: [
    // prettier-ignore
    { labelI18nKey: 'personal-information:home-address.edit.breadcrumbs.personal-information', routeId: 'protected/personal-information/index' },
    ...
    <>
      ...
      <fetcher.Form className="max-w-prose" method="post" noValidate>
        ...
        <div className="my-6">
          <div className="space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <InputField id="city-name" name="cityName" className="w-full" label={t('personal-information:home-address.edit.field.city')} maxLength={100} required defaultValue={addressInfo.cityName} errorMessage={errors?.cityName} />
              <InputField
                id="postal-code"
                name="postalCode"
                className="w-full"
        ...
        <div className="flex flex-wrap items-center gap-3">
          <ButtonLink id="back-button" routeId="protected/personal-information/index" params={params} disabled={isSubmitting} data-gc-analytics-customclick="ESDC-EDSC:CDCP Personal Information:Back - Home address click">
