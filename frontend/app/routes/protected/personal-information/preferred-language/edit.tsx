...
export const handle = {
  breadcrumbs: [
    // prettier-ignore
    { labelI18nKey: 'personal-information:preferred-language.edit.breadcrumbs.personal-information', routeId: 'protected/personal-information/index' },
    ...
    <>
      ...
      <fetcher.Form method="post" noValidate>
        ...
        <div className="flex flex-wrap items-center gap-3">
          <ButtonLink id="cancel-button" routeId="protected/personal-information/index" params={params} disabled={isSubmitting} data-gc-analytics-customclick="ESDC-EDSC:CDCP Personal Information:Back - Preferred Language click">
