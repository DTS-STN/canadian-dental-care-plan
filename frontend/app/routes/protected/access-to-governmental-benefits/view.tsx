...
export default function AccessToGovernmentalsBenefitsView() {
  ...
  return (
    <div className="max-w-prose">
      ...
      <div className="mb-5 space-y-4">
        <InlineLink routeId="protected/access-to-governmental-benefits/edit" params={{ ...params }} data-gc-analytics-customclick="ESDC-EDSC:CDCP Personal Information:Update your access to governmental benefits - Access to governmental benefits click">
      ...
      <fetcher.Form method="post" noValidate>
        ...
        <div className="flex flex-wrap items-center gap-3">
          <ButtonLink id="back-button" routeId="protected/access-to-governmental-benefits/index" params={params} data-gc-analytics-customclick="ESDC-EDSC:CDCP Personal Information:Back - Access to governmental benefits click">
