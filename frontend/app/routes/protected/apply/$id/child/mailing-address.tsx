...
export const handle = {
  ...
  pageIdentifier: pageIds.protected.apply.child.mailingAddress,
  pageTitleI18nKey: 'protected-apply-child:address.mailing-address.page-title',
...
export async function loader({ context: { appContainer, session }, params, request }: Route.LoaderArgs) {
  ...
  const meta = { title: t('gcweb:meta.title.msca-template', { title: t('protected-apply-child:address.mailing-address.page-title') }) };

  const idToken: IdToken = session.get('idToken');
  appContainer.get(TYPES.AuditService).createAudit('page-view.apply.child.mailing-address', { userId: idToken.sub });
...
export async function action({ context: { appContainer, session }, params, request }: Route.ActionArgs) {
  ...
  if (canProceedToDental) {
    ...
    appContainer.get(TYPES.AuditService).createAudit('update-data.apply.child.mailing-address', { userId: idToken.sub });
    ...
    return redirect(isCopyMailingToHome ? getPathById('protected/apply/$id/child/phone-number', params) : getPathById('protected/apply/$id/child/home-address', params));
  }
...
export default function ApplyChildMailingAddress({ loaderData, params }: Route.ComponentProps) {
          ...
          <fieldset className="mb-6">
            <div className="space-y-6">
              ...
              <InputCheckbox id="sync-addresses" name="syncAddresses" value="true" checked={copyAddressChecked} onChange={checkHandler}>
                {t('protected-apply-child:address.home-address.use-mailing-address')}
              </InputCheckbox>
            </div>
          </fieldset>
          {editMode ? (
            <div className="flex flex-wrap items-center gap-3">
              ...
              <Button id="cancel-button" name="_action" variant="secondary" disabled={isSubmitting} value={FORM_ACTION.cancel} data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form-Protected-Child:Cancel - Mailing address click">
            ...
            <div className="flex flex-row-reverse flex-wrap items-center justify-end gap-3">
              ...
              <ButtonLink
                id="back-button"
                variant="secondary"
                routeId="protected/apply/$id/child/marital-status"
                params={params}
