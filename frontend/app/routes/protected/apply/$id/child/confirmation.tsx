      ...
      <section>
        <ContextualAlert type="comment">
          <div className="space-y-4">
            ...
            <ButtonLink id="survey-button" to={surveyLink} params={params} target="_blank" data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form-Protected-Child:Confirmation survey button - Take the survey click" variant="primary">
