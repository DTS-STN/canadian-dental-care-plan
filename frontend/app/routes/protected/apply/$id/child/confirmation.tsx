...
export async function loader({ context: { appContainer, session }, params, request }: Route.LoaderArgs) {
  ...
  const meta = { title: t('gcweb:meta.title.msca-template', { title: t('protected-apply-child:confirm.page-title') }) };
    ...
    <div className="max-w-prose space-y-10">
      ...
      <Dialog>
        ...
        <DialogContent aria-describedby={undefined} className="sm:max-w-md">
          ...
          <DialogFooter>
            <DialogClose asChild>
              <Button id="confirm-modal-back" variant="secondary" size="sm" data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form-Protected-Child:Back exit modal - Application successfully submitted click">
