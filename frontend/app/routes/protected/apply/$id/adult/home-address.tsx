...
export const handle = {
  ...
  pageIdentifier: pageIds.protected.apply.adult.homeAddress,
  pageTitleI18nKey: 'protected-apply-adult:address.home-address.page-title',
...
export async function loader({ context: { appContainer, session }, params, request }: Route.LoaderArgs) {
  ...
  appContainer.get(TYPES.domain.services.AuditService).createAudit('view-page.apply.adult.home-address', { userId: idToken.sub });
...
export async function action({ context: { appContainer, session }, params, request }: Route.ActionArgs) {
  ...
  if (formAction === FORM_ACTION.cancel) {
    instrumentationService.countHttpStatus('protected.apply.adult.home-address', 302);
  ...
  if (!parsedDataResult.success) {
    instrumentationService.countHttpStatus('protected.apply.adult.home-address', 400);
  ...
  if (canProceedToDental) {
    ...
    return redirect(getPathById('protected/apply/$id/adult/phone-number', params));
  }
  ...
  if (addressCorrectionResult.status === 'not-correct') {
    instrumentationService.countHttpStatus('protected.apply.adult.home-address.address-invalid', 200);
    return {
  ...
  if (addressCorrectionResult.status === 'corrected') {
    ...
    instrumentationService.countHttpStatus('protected.apply.adult.home-address.address-suggestion', 200);
    return {
...
export default function ProtectedApplyAdultHomeAddress({ loaderData, params }: Route.ComponentProps) {
  ...
  return (
    <>
      <div className="my-6 sm:my-8">
        <Progress value={55} size="lg" label={t('protected-apply:progress.label')} />
      </div>
