...
export async function loader({ context: { appContainer, session }, params, request }: Route.LoaderArgs) {
  ...
  const meta = { title: t('gcweb:meta.title.msca-template', { title: t('protected-apply-adult:review-information.page-title') }) };
  ...
  appContainer.get(TYPES.AuditService).createAudit('page-view.apply.adult.review-information', { userId: idToken.sub });
...
export async function action({ context: { appContainer, session }, params, request }: Route.ActionArgs) {
  ...
  const benefitApplicationDto = appContainer.get(TYPES.BenefitApplicationStateMapper).mapApplyAdultStateToBenefitApplicationDto(state);
  ...
  const idToken: IdToken = session.get('idToken');
  appContainer.get(TYPES.AuditService).createAudit('update-data.apply.adult.review-information', { userId: idToken.sub });
      ...
      <div className="max-w-prose">
          ...
          <section className="space-y-6">
            ...
            <dl className="divide-y border-y">
              ...
              <DescriptionListItem term={t('protected-apply-adult:review-information.marital-title')}>
                ...
                <div className="mt-4">
                  <InlineLink id="change-marital-status" routeId="protected/apply/$id/adult/marital-status" params={params}>
          ...
          <section className="space-y-6">
            ...
            <dl className="divide-y border-y">
              <DescriptionListItem term={t('protected-apply-adult:review-information.lang-pref-title')}>
                <p>{userInfo.preferredLanguage.name}</p>
                <div className="mt-4">
        ...
        <fetcher.Form onSubmit={handleSubmit} method="post" className="mt-8 flex flex-row-reverse flex-wrap items-center justify-end gap-3">
          ...
          <Button
            ...
            data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form-Protected-Adult:Exit - Review your information click"
          >
