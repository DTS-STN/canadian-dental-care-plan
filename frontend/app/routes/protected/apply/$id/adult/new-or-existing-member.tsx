  ...
  const newOrExistingMemberSchema = z
    .object({
      newOrExistingMember: z.nativeEnum(NEW_OR_EXISTING_MEMBER_OPTION, {
        errorMap: () => ({ message: t('protected-apply-adult:new-or-existing-member.error-message.is-new-or-existing-member-required') }),
      }),
      clientNumber: z
        .string()
        .trim()
        ...
        <fetcher.Form method="post" noValidate>
          ...
          {editMode ? (
            <div className="mt-8 flex flex-wrap items-center gap-3">
              ...
              <Button id="cancel-button" name="_action" value={FORM_ACTION.cancel} disabled={isSubmitting} data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form-Protected-Adult:Cancel - New or existing member click">
