...
export const handle = {
  i18nNamespaces: getTypedI18nNamespaces('protected-apply-adult-child', 'protected-apply', 'protected-apply', 'gcweb'),
...
export async function loader({ context: { appContainer, session }, params, request }: Route.LoaderArgs) {
  ...
  appContainer.get(TYPES.AuditService).createAudit('page-view.apply.adult-child.confirmation', { userId: idToken.sub });
...
export async function action({ context: { appContainer, session }, params, request }: Route.ActionArgs) {
  ...
  const idToken: IdToken = session.get('idToken');
  appContainer.get(TYPES.AuditService).createAudit('update-data.apply.adult-child.confirmation', { userId: idToken.sub });
      ...
      <section>
        <ContextualAlert type="comment">
          <div className="space-y-4">
            ...
            <ButtonLink id="survey-button" to={surveyLink} params={params} target="_blank" data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form-Protected-Adult_Child:Confirmation survey button - Take the survey click" variant="primary">
          ...
          <DialogFooter>
            ...
            <fetcher.Form method="post" noValidate>
              ...
              <Button
                ...
                data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form-Protected-Adult_Child:Return to my dashboard - Application successfully submitted click"
              >
