  ...
  const applicantInformationSchema = z
    .object({
      socialInsuranceNumber: z
        ...
        .superRefine((sin, ctx) => {
          if (!isValidSin(sin)) {
            ctx.addIssue({ code: z.ZodIssueCode.custom, message: t('protected-apply-adult-child:applicant-information.error-message.sin-valid') });
          } else if (
            ...
            ctx.addIssue({ code: z.ZodIssueCode.custom, message: t('protected-apply-adult-child:children.information.error-message.sin-unique') });
          }
        }),
      firstName: z
        .string()
                ...
                options={[
                  {
                    ...
                    children: t('applicant-information.radio-options.yes'),
                    defaultChecked: defaultState?.disabilityTaxCredit === DTC_OPTION.yes,
                  },
                  {
                    value: DTC_OPTION.no,
                    children: t('applicant-information.radio-options.no'),
