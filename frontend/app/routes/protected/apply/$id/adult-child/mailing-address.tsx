...
export const handle = {
  ...
  pageIdentifier: pageIds.protected.apply.adultChild.mailingAddress,
  pageTitleI18nKey: 'protected-apply-adult-child:address.mailing-address.page-title',
...
export async function loader({ context: { appContainer, session }, params, request }: Route.LoaderArgs) {
  ...
  const meta = { title: t('gcweb:meta.title.msca-template', { title: t('protected-apply-adult-child:address.mailing-address.page-title') }) };
...
export async function action({ context: { appContainer, session }, params, request }: Route.ActionArgs) {
  ...
  if (canProceedToDental) {
    ...
    return redirect(isCopyMailingToHome ? getPathById('protected/apply/$id/adult-child/phone-number', params) : getPathById('protected/apply/$id/adult-child/home-address', params));
  }
...
export default function ApplyAdultChildMailingAddress({ loaderData, params }: Route.ComponentProps) {
  ...
  return (
    <>
      <div className="my-6 sm:my-8">
        <Progress value={44} size="lg" label={t('protected-apply:progress.label')} />
      </div>
          ...
          <fieldset className="mb-6">
            <div className="space-y-6">
              ...
              <InputCheckbox id="sync-addresses" name="syncAddresses" value="true" checked={copyAddressChecked} onChange={checkHandler}>
                {t('protected-apply-adult-child:address.home-address.use-mailing-address')}
              </InputCheckbox>
            </div>
          </fieldset>
          {editMode ? (
            <div className="flex flex-wrap items-center gap-3">
              ...
              <Button id="cancel-button" name="_action" variant="secondary" disabled={isSubmitting} value={FORM_ACTION.cancel} data-gc-analytics-customclick="ESDC-EDSC:CDCP Online Application Form-Protected-Adult_Child:Cancel - Mailing address click">
            ...
            <div className="flex flex-row-reverse flex-wrap items-center justify-end gap-3">
              ...
              <ButtonLink
                id="back-button"
                variant="secondary"
                routeId="protected/apply/$id/adult-child/marital-status"
                params={params}
