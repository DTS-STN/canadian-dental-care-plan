...
export default function ApplyFlowFileYourTaxes() {
  ...
  const taxInfo = <InlineLink to={t('apply-adult:eligibility.file-your-taxes.tax-info-href')} className="external-link font-lato font-semibold" newTabIndicator target="_blank" />;
