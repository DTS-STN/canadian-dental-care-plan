...
export const handle = {
  ...
  pageIdentifier: pageIds.public.apply.adultChild.personalInformation,
...
export async function action({ context: { session }, params, request }: ActionFunctionArgs) {
  const log = getLogger('apply/adult-child/personal-information');
  ...
  const personalInformationSchema = z
    .object({
      phoneNumber: z
        ...
        .trim()
        .max(100)
        .refine((val) => !val || isValidPhoneNumber(val, 'CA'), t('apply-adult-child:contact-information.error-message.phone-number-valid'))
        .optional(),
      phoneNumberAlt: z
        .string()
        .trim()
    ...
    .superRefine((val, ctx) => {
      if (val.email) {
        ...
        if (typeof val.confirmEmail !== 'string' || validator.isEmpty(val.confirmEmail)) {
          ...
          ctx.addIssue({ code: z.ZodIssueCode.custom, message: t('apply-adult-child:contact-information.error-message.email-valid'), path: ['confirmEmail'] });
            ...
            <div className="my-6 space-y-6">
              ...
              <div className="grid items-end gap-6 md:grid-cols-2">
                ...
                <InputField
                  ...
                  className="w-full"
                  label={
                    selectedMailingCountry === CANADA_COUNTRY_ID || selectedMailingCountry === USA_COUNTRY_ID
                      ? t('apply-adult-child:contact-information.address-field.postal-code')
                      : t('apply-adult-child:contact-information.address-field.postal-code-optional')
                  }
                  maxLength={100}
                ...
                <>
                  ...
                  <div className="mb-6 grid items-end gap-6 md:grid-cols-2">
                    ...
                    <InputField
                      ...
                      className="w-full"
                      label={
                        selectedHomeCountry === CANADA_COUNTRY_ID || selectedHomeCountry === USA_COUNTRY_ID
                          ? t('apply-adult-child:contact-information.address-field.postal-code')
                          : t('apply-adult-child:contact-information.address-field.postal-code-optional')
                      }
                      maxLength={100}
