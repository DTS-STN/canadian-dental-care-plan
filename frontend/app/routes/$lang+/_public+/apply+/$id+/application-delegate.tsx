...
export default function ApplyFlowApplicationDelegate() {
  ...
  const contactServiceCanada = <InlineLink to={t('apply:eligibility.application-delegate.contact-service-canada-href')} className="external-link font-lato font-semibold" newTabIndicator target="_blank" />;
  const preparingToApply = <InlineLink to={t('apply:eligibility.application-delegate.preparing-to-apply-href')} className="external-link font-lato font-semibold" newTabIndicator target="_blank" />;
