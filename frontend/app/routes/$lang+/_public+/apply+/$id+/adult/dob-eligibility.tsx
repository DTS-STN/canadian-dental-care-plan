...
export default function ApplyFlowDobEligibility() {
  ...
  const eligibilityInfo = <InlineLink to={t('apply-adult:eligibility.dob-eligibility.eligibility-info-href')} className="external-link font-lato font-semibold" newTabIndicator target="_blank" />;
