    ...
    <>
      ...
      <div className="max-w-prose">
        ...
        <fetcher.Form method="post" noValidate>
          ...
          <fieldset>
            <legend className="my-6 font-lato text-2xl font-bold">{t('apply-adult:dental-benefits.federal-benefits.title')}</legend>
            <InputRadios
          ...
          <fieldset>
            <legend className="my-6 font-lato text-2xl font-bold">{t('apply-adult:dental-benefits.provincial-territorial-benefits.title')}</legend>
