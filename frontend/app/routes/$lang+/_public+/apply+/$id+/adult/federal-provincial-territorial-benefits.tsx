        ...
        <fetcher.Form method="post" noValidate aria-describedby="access-to-benefits-note eligibility-note form-instructions">
          ...
          <section>
            <p className="mb-4" id="access-to-benefits-note">
              {t('apply-adult:dental-benefits.access-to-dental')}
            </p>
            <p className="mb-4" id="eligibility-note">
              {t('apply-adult:dental-benefits.eligibility-criteria')}
            </p>
            <p className="mb-6 italic" id="form-instructions">
              {t('apply:required-label')}
            </p>
            <h2 className="my-6 font-lato text-2xl font-bold">{t('apply-adult:dental-benefits.federal-benefits.title')}</h2>
            <InputRadios
          ...
          <section>
            <h2 className="my-6 font-lato text-2xl font-bold">{t('apply-adult:dental-benefits.provincial-territorial-benefits.title')}</h2>
