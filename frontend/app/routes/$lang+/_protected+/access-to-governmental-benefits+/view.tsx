...
export async function loader({ context: { session }, params, request }: LoaderFunctionArgs) {
  ...
  return json({ meta, t, personalInformation, federalSocialProgramsList, provincialAndTerritorialProgramsList, csrfToken });
}
...
export default function AccessToGovernmentalsBenefitsView() {
  ...
  const { csrfToken, personalInformation, federalSocialProgramsList, provincialAndTerritorialProgramsList } = useLoaderData<typeof loader>();
