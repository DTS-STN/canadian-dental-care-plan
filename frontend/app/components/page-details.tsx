...
export function PageDetails() {
  ...
  return (
    <section className="mt-16 mb-8">
      <h2 className="sr-only">{t('gcweb:pageDetails.pageDetails')}</h2>
      <dl id="wb-dtmd" className="space-y-1">
        {!!pageIdentifier && (
          <div className="flex gap-2">
            <dt>{t('gcweb:pageDetails.screenId')}</dt>
            <dd>
        ...
        {!!buildInfo.buildDate && (
          <div className="flex gap-2">
            <dt>{t('gcweb:pageDetails.dateModfied')}</dt>
            <dd>
        ...
        {!!buildInfo.buildVersion && (
          <div className="flex gap-2">
            <dt>{t('gcweb:pageDetails.version')}</dt>
            <dd>
