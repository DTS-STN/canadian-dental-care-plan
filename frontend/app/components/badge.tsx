...
const badgeVariants = cva(
  'inline-flex w-fit shrink-0 items-center justify-center gap-1 overflow-hidden rounded-full border border-transparent font-medium whitespace-nowrap transition-[color,box-shadow] focus-visible:ring-[3px] [&>svg]:pointer-events-none',
  {
    variants: {
      size: {
        sm: 'px-1.5 py-0.5 text-xs [&>svg]:size-3',
        base: 'px-2 py-1 text-base leading-none [&>svg]:size-3.5',
        lg: 'px-2.5 py-1.5 text-lg leading-none [&>svg]:size-4',
      },
      variant: {
