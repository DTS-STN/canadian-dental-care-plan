export const pageIds = {
  protected: {
    ...
    renew: {
      ...
      typeOfRenewal: 'CDCP-RENW-0005',
      renewalDelegate: 'CDCP-RENW-0006',
      dentalInsurance: 'CDCP-PROT-RENW-0007',
      demographicSurvey: 'CDCP-PROT-RENW-0008',
      maritalStatus: 'CDCP-PROT-RENW-0009',
      parentOrGuardian: 'CDCP-PROT-RENW-0010',
  ...
  public: {
    ...
    demographicSurvey: {
      termsAndConditions: 'CDCP-DMSV-0001',
      summary: 'CDCP-DMSV-0002',
      questions: 'CDCP-DMSV-0003',
      submitted: 'CDCP-DMSV-0004',
    },
