...
describe('public-application-full-section-checks', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  describe('isChildInformationSectionCompleted', () => {
    ...
    it('should return false when date of birth is empty string', () => {
      ...
      expect(isChildInformationSectionCompleted({ context: 'intake', applicationYear: APPLICATION_YEAR }, child)).toBe(false);
    });
