...
describe('apply-child-route-helpers.server', () => {
  ...
  describe('validateApplyChildStateForReview', () => {
    ...
    it('should redirect if a child information is undefined', () => {
      ...
      expect(() => validateApplyChildStateForReview({ params, state: mockState })).toThrow('MockedRedirect(MockedPath($lang/_public/apply/$id/child/children/$childId/information, {"lang":"en","id":"00000000-0000-0000-0000-000000000000","childId":"1"}))');
    });
    ...
    it('should redirect if contactInformation is undefined', () => {
      ...
      expect(() => validateApplyChildStateForReview({ params, state: mockState })).toThrow('MockedRedirect(MockedPath($lang/_public/apply/$id/child/contact-information, {"lang":"en","id":"00000000-0000-0000-0000-000000000000"}))');
    });
