...
describe('renew-route-helpers', () => {
  describe('transformAdobeAnalyticsUrl', () => {
    it.each([
      ...
      ['https://example.com/fr/protege/renouveler/00000000-0000-0000-0000-000000000000/somepage/'],
    ...
    it.each([
      ...
      ['https://example.com/en/renouveler/00000000-0000-0000-0000-000000000000/somepage/', 'https://example.com/en/renouveler/somepage/'],
      ['https://example.com/fr/renouveler/00000000-0000-0000-0000-000000000000/somepage/', 'https://example.com/fr/renouveler/somepage/'],
  ...
  describe('transformAdultChildChildrenRouteAdobeAnalyticsUrl', () => {
    ...
    it.each([
      ...
      ['https://example.com/en/renouveler/00000000-0000-0000-0000-000000000000/adulte-enfant/enfants/00000000-0000-0000-0000-000000000000/somepage/', 'https://example.com/en/renouveler/adulte-enfant/enfants/somepage/'],
      ['https://example.com/fr/renouveler/00000000-0000-0000-0000-000000000000/adulte-enfant/enfants/00000000-0000-0000-0000-000000000000/somepage/', 'https://example.com/fr/renouveler/adulte-enfant/enfants/somepage/'],
  ...
  describe('transformChildChildrenRouteAdobeAnalyticsUrl', () => {
    ...
    it.each([
      ...
      ['https://example.com/en/renouveler/00000000-0000-0000-0000-000000000000/enfant/enfants/00000000-0000-0000-0000-000000000000/somepage/', 'https://example.com/en/renouveler/enfant/enfants/somepage/'],
      ['https://example.com/fr/renouveler/00000000-0000-0000-0000-000000000000/enfant/enfants/00000000-0000-0000-0000-000000000000/somepage/', 'https://example.com/fr/renouveler/enfant/enfants/somepage/'],
